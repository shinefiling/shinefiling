...
import com.shinefiling.legal.dto.FranchiseAgreementRegistrationRequest;
...
public class FranchiseAgreementController {
    ...
    private static final String SERVICE_NAME = "Franchise Agreement";

    @PostMapping("/apply")
    public ResponseEntity<?> apply(@RequestBody FranchiseAgreementRegistrationRequest requestDTO) {
        try {
            ...
            // 2. Automation Tasks
            List<FranchiseAgreementRegistrationRequest.AutomationTaskDTO> tasks = new ArrayList<>();
            tasks.add(createTask("DRAFTING", "Drafting of Franchise Agreement.", "HIGH"));
            ...
            createdRequest.setAmount(requestDTO.getAmountPaid() != null ? requestDTO.getAmountPaid() : 3499.0);
            ...
            try {
                ...
                FranchiseAgreementDTO formData = requestDTO.getFormData();
                if (formData != null) {
    ...
    private FranchiseAgreementRegistrationRequest.AutomationTaskDTO createTask(String taskName, String desc,
            String priority) {
        FranchiseAgreementRegistrationRequest.AutomationTaskDTO t = new FranchiseAgreementRegistrationRequest.AutomationTaskDTO();
        t.setTask(taskName);
