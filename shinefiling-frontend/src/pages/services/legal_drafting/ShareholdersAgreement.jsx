...
import { CheckCircle, Users, Briefcase, FileText, Scale, HelpCircle, Shield, BookOpen, Clock, Zap, ChevronRight, Star, ArrowRight, UserCheck, PieChart } from 'lucide-react';
...
const ShareholdersAgreement = ({ isLoggedIn }) => {
    ...
    const faqs = [
        { q: "What is the purpose of this agreement?", a: "It regulates the relationship between shareholders and outlines their rights and obligations." },
        { q: "Does it override MOA/AOA?", a: "Generally, the Articles of Association (AOA) should be amended to reflect the terms of the Shareholders' Agreement (SHA) for better enforceability." },
        { q: "What is ROFR?", a: "Right of First Refusal: Existing shareholders have the right to match an offer before shares are sold to an outsider." },
        { q: "What are Tag-Along rights?", a: "If a majority shareholder sells their stake, minority shareholders have the right to join the deal and sell their shares too." },
        { q: "What are Drag-Along rights?", a: "Majority shareholders can force minority shareholders to sell their stake during a company sale." },
    ];
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            ...
                            >
                                ...
                                <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                                    Definitive agreement governing the relationship between the company and its shareholders, protecting minority rights and defining exit routes.
                                </p>
                            </motion.div>
                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6 flex items-center gap-3">
                            <Shield className="text-bronze" /> Critical Clauses
                        </h2>
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { title: "Right of First Refusal", desc: "Prevents shares from being sold to unknown 3rd parties." },
                                { title: "Tag-Along / Drag-Along", desc: "Protects minority and majority rights during exits." },
                                { title: "Board Representation", desc: "Guarantees a board seat for major investors." },
                                { title: "Anti-Dilution", desc: "Protects investors if shares are sold at a lower price later." },
                                { title: "Voting Rights", desc: "Super-majority requirements for key decisions." },
                                { title: "Information Rights", desc: "Right to receive periodic financial statements." },
                            ].map((item, i) => (
                    ...
                    <section id="pricing-plans">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-[#2B3446] rounded-3xl p-6 shadow-2xl relative overflow-hidden transform md:-translate-y-4 flex flex-col">
                                ...
                                <h3 className="text-xl font-bold text-white mb-2">Standard SHA</h3>
                                <div className="text-4xl font-black text-white mb-1">₹4,999</div>
                                <p className="text-xs text-gray-400 mb-6">/ Agreement</p>
                                <ul className="space-y-3 mb-8 flex-1">
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Thorough Customization</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> 2 Rounds Revision</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Senior Lawyer Draft</li>
                                </ul>
                            ...
                            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative group flex flex-col">
                                <h3 className="text-xl font-bold text-navy mb-2">SHA Review</h3>
                                <div className="text-4xl font-black text-navy mb-1">₹2,499</div>
                                <p className="text-xs text-slate-400 mb-6">/ Review</p>
                                <ul className="space-y-3 mb-8 flex-1">
                                    <li className="flex gap-3 text-sm text-gray-600"><CheckCircle size={16} className="text-bronze shrink-0" /> Review Investor Draft</li>
                                    <li className="flex gap-3 text-sm text-gray-600"><CheckCircle size={16} className="text-bronze shrink-0" /> Highlight Risks</li>
                                    <li className="flex gap-3 text-sm text-gray-600"><CheckCircle size={16} className="text-bronze shrink-0" /> Negotiation Points</li>
                                </ul>
