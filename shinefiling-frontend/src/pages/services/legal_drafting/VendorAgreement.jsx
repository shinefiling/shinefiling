                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 items-center">
                        ...
                        >
                            ...
                            <button onClick={() => handlePlanSelect('msa')} className="w-full py-3 bg-slate-100 text-navy font-bold rounded-xl hover:bg-slate-200 transition-colors">Select MSA</button>
                        </motion.div>
                    </div>
                </div>
            </section>
