                    ...
                    <div className="grid md:grid-cols-3 gap-8 items-center">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 mb-4">
                                <span className="text-3xl font-black text-navy">₹299</span>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <span className="text-xs font-bold text-gray-400 line-through">₹1,000</span>
                            </div>
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-2xl p-6 border mt-4 border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col h-full"
                        >
                            <h3 className="text-lg font-bold text-navy mb-2">Print & Deliver</h3>
                            <p className="text-slate-500 text-sm mb-6">Home Delivered on Stamp Paper.</p>
                            <div className="flex items-baseline gap-1 mb-4">
                                <span className="text-3xl font-black text-navy border-b-2 border-slate-100">₹999</span>
                            ...
                            <button onClick={() => handlePlanSelect('print')} className="w-full py-2.5 bg-slate-100 text-navy font-bold rounded-lg hover:bg-slate-200 transition-colors text-sm">Choose Print</button>
                        </motion.div>
                    </div>
                </div>
            </section>
