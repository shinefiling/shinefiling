...
const ProprietorshipClosureRegistration = ({ isLoggedIn, isModal = false, onClose, planProp }) => {
    ...
    useEffect(() => {
        ...
        if (!isReallyLoggedIn) {
            const planParam = searchParams.get('plan') || 'full';
            navigate('/login', { state: { from: `/services/business-closure/proprietorship-closure/apply?plan=${planParam}` } });
        } else {
                ...
                <div className="w-72 bg-[#043E52] text-white flex flex-col p-6 shrink-0 relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-8">
                        <h1 className="font-bold text-lg flex items-center gap-2 tracking-tight">
                            <span className="text-[#ED6E3F]">Business</span>
                            Closure
                        </h1>
