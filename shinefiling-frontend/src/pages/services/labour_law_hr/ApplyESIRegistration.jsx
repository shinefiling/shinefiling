...
import { submitESIRegistration } from '../../../api';

const ApplyESIRegistration = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await submitESIRegistration(payload);
            ...
            <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-lg font-bold text-slate-800">ESI Registration Application</h1>
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition font-medium text-slate-800"
                                        placeholder="Total employees (Minimum 10)"
                                    />
                                </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {[
                                    ...
                                    { id: 'employeeList', label: 'Employee List (Excel/PDF) with wages' }
                                ].map((doc) => (
