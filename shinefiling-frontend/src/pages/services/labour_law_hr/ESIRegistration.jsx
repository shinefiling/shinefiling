...
import { CheckCircle, Shield, Activity, HelpCircle, HeartPulse, Stethoscope, Baby, FileText, Users, ArrowRight, Zap, BookOpen, Clock, Star, UserCheck, ChevronRight } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

const ESIRegistration = ({ isLoggedIn }) => {
    const navigate = useNavigate();

    useEffect(() => { window.scrollTo(0, 0); }, []);

    const handlePlanSelect = (plan) => {
        const url = `/services/labour-law-hr/esi-registration/apply?plan=${plan}`;
        if (isLoggedIn) navigate(url);
        else navigate('/login', { state: { from: url } });
    };

    const faqs = [
        { q: "What is ESI?", a: "Employee's State Insurance (ESI) is a self-financing social security and health insurance scheme for Indian workers." },
        { q: "Who is eligible?", a: "Employees with wages up to ₹21,000 per month are covered under this scheme. It is mandatory for establishments with 10+ employees." },
        { q: "What are the contribution rates?", a: "Employer contributes 3.25% and Employee contributes 0.75% of the wages." },
        { q: "What benefits does it offer?", a: "It covers medical, sickness, maternity, disability, and dependent benefits." },
    ];
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            ...
                            >
                                <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-bronze/20 text-bronze border border-bronze/30 rounded-full text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-sm">
                                    <HeartPulse size={12} className="fill-bronze" /> Health Insurance
                                </span>
                                ...
                                <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                                    Provide comprehensive medical care and social security to your workforce. Compliance made simple and affordable.
                                </p>
                            </motion.div>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    ...
                                    <div className="text-left">
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Benefits</p>
                                        <p className="font-bold text-sm text-white">Full Medical</p>
                                    </div>
                                </div>
                            </motion.div>
                        ...
                        >
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative">
                                ...
                                <div className="text-center mb-6">
                                    <h3 className="text-navy font-bold text-xl mb-2">ESI New Reg</h3>
                                ...
                                <div className="space-y-4 mb-8">
                                    {["Employer Code Allotment", "Employee Registration", "Family Details Upload", "Pehchan Card Guide", "Portal Login Setup"].map((item, i) => (
                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6 flex items-center gap-3">
                            <BookOpen className="text-bronze" /> Coverage & Applicability
                        </h2>
                        <div className="space-y-6">
                            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm relative pl-16">
                                ...
                                <h3 className="text-xl font-bold text-navy mb-2">Establishment Check</h3>
                                <p className="text-gray-600 mb-2 text-sm">
                                    Applied to factories and other establishments (shops, hotels, cinemas, etc.) employing 10 or more persons.
                                </p>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm relative pl-16">
                                ...
                                <h3 className="text-xl font-bold text-navy mb-2">Wage Limit</h3>
                                <p className="text-gray-600 mb-2 text-sm">
                                    Employees drawing gross monthly wages up to ₹21,000 (₹25,000 for persons with disabilities).
                                </p>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm relative pl-16">
                                ...
                                <h3 className="text-xl font-bold text-navy mb-2">Contribution</h3>
                                <p className="text-gray-600 mb-2 text-sm">
                                    Total 4% of wages (Employer: 3.25%, Employee: 0.75%).
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { title: "Medical Benefit", desc: "Full medical care to the insured person and family members from day one.", icon: Stethoscope },
                                { title: "Sickness Benefit", desc: "Cash compensation during certified periods of illness (70% of wages).", icon: Activity },
                                { title: "Maternity Benefit", desc: "Paid leave for 26 weeks for confinement/pregnancy related needs.", icon: Baby },
                                { title: "Disablement Benefit", desc: "Pension/allowance in case of temporary or permanent disablement due to employment injury.", icon: Shield },
                            ].map((item, i) => (
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-[#2B3446] rounded-3xl p-6 shadow-2xl relative overflow-hidden transform md:-translate-y-4 flex flex-col">
                                ...
                                <ul className="space-y-3 mb-8 flex-1">
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Contribution Filing</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Challan Generation</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Bi-annual Return</li>
                                </ul>
                            ...
                            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative group flex flex-col">
                                ...
                                <ul className="space-y-3 mb-8 flex-1">
                                    <li className="flex gap-3 text-sm text-gray-600"><CheckCircle size={16} className="text-bronze shrink-0" /> 17-Digit Code Number</li>
                                    <li className="flex gap-3 text-sm text-gray-600"><CheckCircle size={16} className="text-bronze shrink-0" /> Employer Login Setup</li>
                ...
                <div className="lg:col-span-4">
                    <div className="sticky top-32 space-y-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Shop Act / Factory License</li>
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Address Proof (Utility Bill)</li>
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> PAN & Bank Details</li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 border-b pb-2">Employees</h4>
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Aadhar & Nominee Details</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#2B3446] text-white p-6 rounded-3xl shadow-lg">
                            ...
                            <p className="text-gray-300 text-sm mb-4">Unsure about employee wage limits?</p>
