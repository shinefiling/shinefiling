            ...
            <div className="relative min-h-[85vh] flex items-center pt-32 pb-20 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                    <motion.div
                        ...
                        className="absolute -top-[20%] -right-[10%] w-[800px] h-[800px] bg-blue-500/20 rounded-full blur-[120px]"
                    />
                    <motion.div
                        animate={{
                            scale: [1, 1.1, 1],
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            ...
                            >
                                <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-bronze/20 text-bronze border border-bronze/30 rounded-full text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-sm">
                                    <Key size={12} className="text-bronze" /> Director Compliance
                                </span>
                                <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-4 text-white tracking-tight">
                                    DIN & DSC <br />
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-bronze to-white">Update & KYC</span>
                                </h1>
                                <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                                    Keep your Director Identification Number (DIN) active and your Digital Signature (DSC) valid. We handle <strong>DIR-3 KYC</strong> filing and <strong>DSC Issuance</strong> seamlessly.
                                </p>
                            </motion.div>
                            ...
                            >
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="font-bold text-sm text-white">DIR-3 KYC</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    <div className="w-10 h-10 rounded-lg bg-bronze/20 flex items-center justify-center text-bronze">
                                    ...
                                    <div className="text-left">
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Renew</p>
                                        <p className="font-bold text-sm text-white">Digital Sign</p>
                                    </div>
                                </div>
                            </motion.div>
            ...
            <section id="pricing-plans" className="py-20 px-6 lg:px-12 bg-white relative overflow-hidden">
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        <span className="text-bronze font-bold tracking-widest uppercase text-xs mb-2 block">Available Services</span>
                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6 flex items-center gap-3">
                            <Laptop className="text-bronze" /> Digital Compliance for Directors
                        </h2>
                        <div className="prose prose-lg text-gray-600">
                            <p className="lead text-xl text-gray-800 font-medium">
                                Every Director in an Indian company is allotted a unique <strong>Director Identification Number (DIN)</strong>. To keep this DIN active, they must file the <strong>DIR-3 KYC</strong> form annually.
                            </p>
                            <p>
                                Failure to file this KYC results in the DIN being marked as "Deactivated due to non-filing of DIR-3 KYC," which prevents the director from signing any company documents or filing returns.
                            </p>
                        </div>
                    </section>
                    ...
                    {/* Process Section */}
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-8">KYC Filing Process</h2>
                        <div className="space-y-6">
                            {[
                                { step: "Step 1", title: "Information Check", days: "Day 1", desc: "Checking current status of DIN on MCA Master Data." },
                                { step: "Step 2", title: "OTP Validation", days: "Day 1", desc: "Generating OTPs on your registered Mobile and Email ID." },
                                { step: "Step 3", title: "Certification", days: "Day 1", desc: "Our Practicing Professional (CA/CS) certifies the form." },
                                { step: "Step 4", title: "Filing", days: "Instant", desc: "Uploading to MCA. DIN status remains 'Approved'." }
                            ].map((item, i) => (
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6 flex items-center gap-3">
                            <Key className="text-bronze" /> Digital Signature Certificate (DSC)
                        </h2>
                        <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
                            <p className="text-gray-700 mb-6">
                                A Class 3 DSC is mandatory for e-filing. It is stored in a secure USB Token.
                            </p>
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                                    <CheckCircle className="text-green-500" />
                                    <span className="font-semibold text-navy">Validity: 2 or 3 Years</span>
                                </div>
                                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                                    <CheckCircle className="text-green-500" />
                                    <span className="font-semibold text-navy">Type: Class 3 Signing</span>
                                </div>
                                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                                    <CheckCircle className="text-green-500" />
                                    <span className="font-semibold text-navy">Token: Drivers Included</span>
                                </div>
                                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                                    <CheckCircle className="text-green-500" />
                                    <span className="font-semibold text-navy">Process: Paperless</span>
                                </div>
                            </div>
                        </div>
                    </section>
                ...
                <div className="lg:col-span-4">
                    <div className="sticky top-32 space-y-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> DIN Number</li>
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Mobile & Email Access</li>
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Aadhaar/Passport (for address change)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#2B3446] text-white p-6 rounded-3xl shadow-lg">
                            <h4 className="font-bold text-lg mb-2">Foreign Director?</h4>
                            <p className="text-gray-300 text-sm mb-4">Foreign Nationals need to file DIR-3 KYC using Apostilled/Notarized documents.</p>
...
export default DINDSCCorrection;
