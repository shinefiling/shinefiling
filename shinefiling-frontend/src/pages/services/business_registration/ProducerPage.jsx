...
import { ArrowLeft, Clock, Star, CheckCircle, FileText, Shield, Zap, ChevronRight, User, Component, Sprout, Tractor, Leaf, Globe, ArrowRight, Users } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

const ProducerPage = ({ isLoggedIn, onLogout }) => {
    ...
    const faqs = [
        { q: "What is a Producer Company?", a: "It is a company registered by farmers or agriculturists to deal with the produce of its members. It combines the goodness of a Cooperative Society with the vibrancy of a Company." },
        { q: "Who can be a member?", a: "Any individual who is a producer (farmer, artisan, etc.) or a Producer Institution can be a member." },
        { q: "What is the minimum requirement?", a: "You need minimum 5 Directors and 10 Individual Members (or 2 Producer Institutions) to start." },
        { q: "Is it restricted to farmers only?", a: "Primary producers involve agriculture, horticulture, animal husbandry, fishery, viticulture, floriculture, forest products, bee raising etc." },
        { q: "Can we sell to non-members?", a: "Yes, you can sell the produce to anyone, but benefits/bonuses are shared primarily among producer members." },
        { q: "Are there tax benefits?", a: "Yes, agricultural income is exempt from tax. However, income from processing/marketing may be taxable, but there are specific deductions available under Income Tax Act." },
    ];
    ...
    return (
        <div className="min-h-screen bg-[#F7F9F2] text-navy font-sans pb-24">
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            ...
                            >
                                ...
                                <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                                    Empowering farmers and producers. The ideal structure for agriculture and cottage industries.
                                </p>
                            </motion.div>
                            ...
                            >
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="font-bold text-sm text-white">20-25 Days</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    <div className="w-10 h-10 rounded-lg bg-bronze/20 flex items-center justify-center text-bronze">
                            ...
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative">
                                ...
                                <div className="text-center mb-6">
                                    ...
                                    <div className="flex justify-center items-end gap-2 mb-2">
                                        <h3 className="text-5xl font-black text-navy tracking-tight">₹19,999</h3>
                                        <span className="text-lg text-slate-400 line-through mb-1 font-medium">₹30,000</span>
                                    </div>
                ...
                <div className="lg:col-span-8 space-y-20">
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6 flex items-center gap-3">
                            <Tractor className="text-slate" /> Transform Agriculture into Business
                        </h2>
                        <div className="prose prose-lg text-gray-600">
                            <p className="lead text-xl text-gray-800 font-medium">
                                A <strong>Producer Company</strong> is a fair-trade model where farmers, artisans, and producers come together to pool their resources for better market access.
                            </p>
                            <p>
                                It is the ideal structure for Farmer Producer Organizations (FPOs). It allows collective bargaining, access to cheaper inputs, and better prices for produce, all while retaining the professional structure of a company.
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { title: "Separate Legal Entity", desc: "It has a distinct identity, can own property, and sue or be sued.", icon: Shield },
                                { title: "Limited Liability", desc: "Members' liability is limited to their share capital, protecting personal assets.", icon: Star },
                                { title: "NABARD Support", desc: "Eligible for various grants, loans, and subsidies from NABARD and SFAC.", icon: Sprout },
                                { title: "Better Credit Access", desc: "Banks lend more easily to registered companies than unorganized farmer groups.", icon: Component },
                            ].map((benefit, i) => (
                                <div key={i} className="flex gap-4 p-6 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-green-200 transition">
                                    <div className="w-14 h-14 rounded-2xl bg-green-50 text-slate flex items-center justify-center flex-shrink-0">
                    ...
                    <section id="pricing-section" className="mb-20">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-slate-500 mt-3">Comprehensive packages for your FPO.</p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative overflow-hidden group">
                                ...
                                <div className="text-3xl font-bold text-navy mb-1">₹14,999</div>
                                <p className="text-xs text-slate-400 mb-6">+ Govt Fees</p>
                                <ul className="space-y-4 mb-8">
                                    {["Name Approval", "Incorporation", "MOA & AOA", "PAN & TAN"].map((feat, i) => (
                            ...
                            <div className="bg-[#2B3446] rounded-3xl p-8 shadow-2xl relative overflow-hidden transform md:-translate-y-4">
                                ...
                                <div className="text-3xl font-bold text-white mb-1">₹24,999</div>
                                <p className="text-xs text-gray-400 mb-6">+ Govt Fees</p>
                                <ul className="space-y-4 mb-8">
                                    {["Everything in Basic", "DSC & DIN (5 Directors)", "Board Resolution", "Bank Account Support"].map((feat, i) => (
                                        <li key={i} className="flex gap-3 text-sm text-gray-300">
                                            <CheckCircle size={16} className="text-lime-400 shrink-0" /> {feat}
                                        </li>
                                    ))}
                                </ul>
                                <button onClick={() => handlePlanSelect('standard')} className="w-full py-3 rounded-xl bg-gradient-to-r from-green-500 to-lime-600 text-white font-bold shadow-lg hover:shadow-green-500/50 transition">Choose Standard</button>
                            </div>

                            {/* Premium */}
                            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative overflow-hidden group">
                                <h3 className="text-xl font-bold text-navy mb-2">Premium</h3>
                                <div className="text-3xl font-bold text-navy mb-1">₹39,999</div>
                                <p className="text-xs text-slate-400 mb-6">+ Govt Fees</p>
                                <ul className="space-y-4 mb-8">
                                    {["Everything in Standard", "Producer/Share Registers", "FPO Compliance Guidance", "1-Year Compliance"].map((feat, i) => (
                                        <li key={i} className="flex gap-3 text-sm text-slate-600">
                                            <CheckCircle size={16} className="text-bronze shrink-0" /> {feat}
                                        </li>
                                    ))}
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            {[
                                { step: "Step 1", title: "DSC & Name", days: "Day 1-3", desc: "Obtaining DSC and reserving name (Producer Company Limited)." },
                                { step: "Step 2", title: "Drafting MOA/AOA", days: "Day 4-7", desc: "Drafting objects related to production, harvesting, etc." },
                                { step: "Step 3", title: "Incorporation", days: "Day 8-15", desc: "Filing SPICe+ with ROC." },
                                { step: "Step 4", title: "Incorporation Cert", days: "Day 16-20", desc: "Receipt of COI, PAN, and TAN." },
                                { step: "Step 5", title: "First Board Meeting", days: "Post-Inc", desc: "Conducting the first board meeting within 30 days." }
                            ].map((item, i) => (
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-8 flex items-center gap-3">
                            <Shield className="text-slate" /> Frequently Asked Questions
                        </h2>
                    ...
                    <div className="sticky top-32 space-y-8">
                        <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
                            <h3 className="font-bold text-xl text-navy mb-6 flex items-center gap-2">
                                <FileText className="text-slate" /> Documents Required
                            </h3>

                            <div className="space-y-6">
                                <div>
                                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 border-b pb-2">Directors/Members</h4>
                                    <ul className="space-y-3">
                                        {["PAN Card", "Aadhaar Card", "Photo", "7/12 Extract (Farmer Proof)"].map((d, i) => (
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        {["Electricity Bill", "NOC from Owner", "Rent Agreement"].map((d, i) => (
                                            <li key={i} className="flex gap-3 text-sm text-gray-700">
                                                <CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" />
                                                {d}
                                            </li>
                ...
                {showRegisterModal && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md p-4 animate-in fade-in duration-300">
                        <div className="relative w-full max-w-6xl max-h-[95vh] rounded-3xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 bg-white ring-1 ring-white/20">
                            <ProducerRegistration isLoggedIn={isLoggedIn} isModal={true} initialPlan={selectedPlan} onClose={() => setShowRegisterModal(false)} />
                        </div>
                    </div>
                )}
            </AnimatePresence>
