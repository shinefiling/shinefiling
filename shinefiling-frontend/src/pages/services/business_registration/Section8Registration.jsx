...
import {
    ...
    User, MapPin, Plus, Trash2, ArrowLeft, ArrowRight, X, IndianRupee, Heart, Building, Users
} from 'lucide-react';
...
const Section8Registration = ({ isLoggedIn, isModal = false, planProp, onClose }) => {
    ...
    const plans = {
        basic: {
            price: 7999,
            title: 'Starter NGO',
            features: ["DSC & DIN (2 Directors)", "Name Approval", "License under Sec 8", "Incorporation Cert."],
            color: 'bg-white border-slate-200'
        },
        standard: {
            price: 14999,
            title: 'Pro NGO',
            features: ["Everything in Starter", "PAN & TAN", "GST Registration", "NGO Darpan Reg."],
            color: 'bg-pink-50 border-pink-200'
        },
        premium: {
            price: 24999,
            title: 'Elite NGO',
            features: ["Everything in Pro", "12A & 80G Registration", "FCRA Consultation", "1st Year Compliance"],
