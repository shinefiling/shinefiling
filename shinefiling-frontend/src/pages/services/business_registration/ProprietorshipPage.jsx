...
import { ArrowLeft, Clock, Star, CheckCircle, FileText, Shield, Zap, ChevronRight, User, Briefcase, Building, Scale, Key, Globe, ArrowRight, Users } from 'lucide-react';
...
const ProprietorshipPage = ({ isLoggedIn, onLogout }) => {
    ...
    const faqs = [
        { q: "What is Sole Proprietorship?", a: "It is the simplest form of business entity owned and managed by a single person. The business and owner are considered the same legal entity." },
        { q: "Is registration mandatory?", a: "While there is no specific 'Sole Proprietorship Registration', you need government registrations like GST, MSME, or Shop & Establishment Act to prove existence." },
        { q: "Can I open a bank account?", a: "Yes, once you have at least two government registrations (like GST + MSME), banks will open a Current Account in the business name." },
        { q: "What is the liability?", a: "The liability is unlimited. The owner is personally responsible for all business debts." },
        { q: "Can I add partners later?", a: "No, you cannot add partners to a Sole Proprietorship. You would need to convert it into a Partnership Firm or LLP." },
        { q: "Documents required?", a: "PAN & Aadhaar of the proprietor, photo, and proof of business address (Electricity bill/Rent Agreement)." },
    ];
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            ...
                            >
                                ...
                                <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                                    The easiest and cheapest way to start a business in India.
                                </p>
                            </motion.div>
                ...
                <div className="lg:col-span-8 space-y-20">
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6 flex items-center gap-3">
                            <User className="text-orange-600" /> What is Sole Proprietorship?
                        </h2>
                        <div className="prose prose-lg text-gray-600">
                            <p className="lead text-xl text-gray-800 font-medium">
                                A <strong>Sole Proprietorship</strong> is a business that is owned and managed by a single individual. It is the easiest type of business to establish.
                            </p>
                            <p>
                                It does not require formal registration with the MCA like a company. Instead, you register with other government departments (GST, MSME, Labor Dept) to legitimize your business.
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { title: "Easy to Start", desc: "Start immediately. Minimal paperwork and low startup cost.", icon: Zap },
                                { title: "Complete Control", desc: "You are the sole boss. No need to consult partners for decisions.", icon: Briefcase },
                                { title: "Tax Benefits", desc: "Income is taxed as personal income. Lower tax rates for lower income slabs.", icon: Scale },
                                { title: "Minimal Compliance", desc: "No annual filings with MCA. Only basic tax returns required.", icon: FileText },
                            ].map((benefit, i) => (
                    ...
                    <section id="pricing-section" className="mb-20">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-slate-500 mt-3">Simple pricing to get your business official.</p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative overflow-hidden group">
                                ...
                                <div className="text-3xl font-bold text-navy mb-1">₹1,999</div>
                                <p className="text-xs text-slate-400 mb-6">+ Govt Fees</p>
                                <ul className="space-y-4 mb-8">
                                    {["Name Registration Guidance", "PAN Verification", "Compliance Check", "Bank Guidance"].map((feat, i) => (
                            ...
                            <div className="bg-[#2B3446] rounded-3xl p-8 shadow-2xl relative overflow-hidden transform md:-translate-y-4">
                                ...
                                <div className="text-3xl font-bold text-white mb-1">₹4,999</div>
                                <p className="text-xs text-gray-400 mb-6">+ Govt Fees</p>
                                <ul className="space-y-4 mb-8">
                                    {["Everything in Basic", "GST Registration", "Shop & Establishment", "MSME Registration", "Bank Account Support"].map((feat, i) => (
                                        <li key={i} className="flex gap-3 text-sm text-gray-300">
                                            <CheckCircle size={16} className="text-orange-500 shrink-0" /> {feat}
                                        </li>
                                    ))}
                                </ul>
                                <button onClick={() => handlePlanSelect('standard')} className="w-full py-3 rounded-xl bg-gradient-to-r from-orange-500 to-amber-600 text-white font-bold shadow-lg hover:shadow-orange-500/50 transition">Choose Standard</button>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative overflow-hidden group">
                                ...
                                <p className="text-xs text-slate-400 mb-6">+ Govt Fees</p>
                                <ul className="space-y-4 mb-8">
                                    {["Everything in Standard", "Professional Tax Reg.", "Current Account (Full Support)", "Invoice & Letterhead", "1-Year Compliance"].map((feat, i) => (
                                        <li key={i} className="flex gap-3 text-sm text-slate-600">
                                            <CheckCircle size={16} className="text-bronze shrink-0" /> {feat}
                                        </li>
                                    ))}
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            {[
                                { step: "Step 1", title: "Documents Collection", days: "Day 1", desc: "Collecting PAN, Aadhaar, and premise proof." },
                                { step: "Step 2", title: "MSME/Udyam Reg", days: "Day 2", desc: "Filing for Udyam Registration certificate." },
                                { step: "Step 3", title: "GST Registration", days: "Day 3-5", desc: "Applying for GSTIN (if required/opted)." },
                                { step: "Step 4", title: "Shop Act (Intimation)", days: "Varries", desc: "State specific Shop & Establishment intimation." },
                                { step: "Step 5", title: "Business Commencement", days: "Immediate", desc: "You can start billing immediately." }
                            ].map((item, i) => (
                ...
                <div className="lg:col-span-4">
                    <div className="sticky top-32 space-y-8">
                        <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 border-b pb-2">Proprietor</h4>
                                    <ul className="space-y-3">
                                        {["PAN Card", "Aadhaar Card", "Passport Photo"].map((d, i) => (
                                ...
                                <div>
                                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 border-b pb-2">Business Place</h4>
                                    <ul className="space-y-3">
                ...
                {showRegisterModal && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md p-4 animate-in fade-in duration-300">
                        <div className="relative w-full max-w-6xl max-h-[95vh] rounded-3xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 bg-white ring-1 ring-white/20">
                            <ProprietorshipRegistration isLoggedIn={isLoggedIn} isModal={true} initialPlan={selectedPlan} onClose={() => setShowRegisterModal(false)} />
                        </div>
                    </div>
                )}
            </AnimatePresence>
