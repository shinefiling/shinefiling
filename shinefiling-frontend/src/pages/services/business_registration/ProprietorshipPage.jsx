...
const ProprietorshipPage = ({ isLoggedIn, onLogout }) => {
    ...
    const faqs = [
        { q: "What is a Sole Proprietorship?", a: "It is a business owned and managed by a single individual. There is no legal distinction between the owner and the business entity." },
        { q: "How much time does it take to register?", a: "Usually, it takes 3-7 working days to obtain basic registrations like GST or Shop Act, which serve as proof of business." },
        { q: "Is a separate bank account necessary?", a: "Yes, you should open a Current Bank Account in the name of your proprietorship firm to manage business transactions separately." },
        { q: "What is the minimum capital required?", a: "There is no minimum capital requirement. You can start with zero balance." },
        { q: "Can I convert it to a Private Limited later?", a: "Yes, once your business grows, you can easily convert your proprietorship into a Partnership, LLP, or Private Limited Company." },
        { q: "What is the tax rate for a proprietorship?", a: "The business income is taxed at the individual income tax slab rates of the owner. There is no separate corporate tax." }
    ];
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            ...
                            >
                                <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-bronze/20 text-bronze border border-bronze/30 rounded-full text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-sm">
                                    <User size={12} className="fill-bronze" /> India's Most Popular
                                </span>
                                ...
                                <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                                    The simplest way to start your business. <strong className="text-white font-semibold">100% Control</strong>, <strong className="text-white font-semibold">Zero Complexity</strong>. Get your Trade License & GST in days.
                                </p>
                            </motion.div>
                            ...
                            >
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="font-bold text-sm text-white">3-5 Days</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    <div className="w-10 h-10 rounded-lg bg-bronze/20 flex items-center justify-center text-bronze">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="font-bold text-sm text-white">Minimal</p>
                                    </div>
                                </div>
                            </motion.div>
                        ...
                        >
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative shadow-inner">
                                ...
                                <div className="flex flex-col items-center justify-center text-center mb-5 mt-2">
                                    ...
                                    <p className="text-slate-500 font-medium text-[10px] mt-1 tracking-wide uppercase">Sole Proprietorship</p>
                                </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 items-center">
                        ...
                        >
                            ...
                            <div className="flex items-baseline gap-1 mb-6">
                                ...
                                <span className="text-gray-500 line-through text-sm">?4k</span>
                            </div>
                ...
                <div id="details-section" className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6 flex items-center gap-3">
                            <Building className="text-bronze" /> About Sole Proprietorship
                        </h2>
                        <div className="prose prose-lg text-gray-600">
                            <p className="lead text-xl text-gray-800 font-medium">
                                A <strong>Sole Proprietorship</strong> is the simplest form of business registration in India, where the business is owned, managed, and controlled by a single individual (Proprietor). Unlike corporate entities, the proprietorship and the owner are considered the same legal entity.
                            </p>
                            <p>
                                It is the ideal choice for small business owners, freelancers, shopkeepers, and independent consultants who want to start their operations immediately with minimal compliance. Since there is no formal registration with the MCA, the legal existence of a proprietorship is established through tax registrations like GST, Udyam (MSME), or the Shop & Establishment Act license.
                            </p>
                            <p>
                                ShineFiling helps you legitimize your business identity in just 3-5 days. We assist you in obtaining the right combination of licenses to ensure you can open a current bank account and operate without legal hassles.
                            </p>
                        </div>
                    </section>
                    ...
                    {/* 6 KEY BENEFITS GRID */}
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-8">Why Start a Proprietorship?</h2>
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { title: "Easiest to Start", desc: "Start in 3-5 days with just PAN and Aadhaar. No complex MCA approvals needed.", icon: Rocket },
                                { title: "Total Control", desc: "You are the boss. Make all decisions instantly without needing partner approval.", icon: User },
                                { title: "Minimal Compliance", desc: "No annual filing with ROC. Only Income Tax Return (ITR) is required annually.", icon: Zap },
                                { title: "Lower Taxes", desc: "Income is taxed at individual slab rates, which can be lower than corporate tax rates.", icon: TrendingUp },
                                { title: "Inexpensive", desc: "Lowest cost of registration among all business types. Very affordable to maintain.", icon: Briefcase },
                                { title: "Easy Closure", desc: "If things don't work out, closing the business is as simple as surrendering the registrations.", icon: ArrowRight },
                            ].map((benefit, i) => (
                    ...
                    <section className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                        <div className="bg-[#2B3446] p-6">
                            <h2 className="text-xl font-bold text-white flex items-center gap-2">
                                <Scale size={20} className="text-bronze" /> Proprietorship vs OPC
                            </h2>
                        </div>
                            ...
                            <table className="w-full text-sm text-left">
                                <thead className="bg-[#2B3446]/5 text-navy">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 bg-beige/10 border-b-2 border-yellow-500">Proprietorship</th>
                                        <th className="px-6 py-4">One Person Company (OPC)</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-100">
                                    <tr className="hover:bg-gray-50"><td className="px-6 py-4 font-bold text-gray-900">Legal Entity</td><td className="px-6 py-4 text-slate font-bold bg-beige/10 text-red-500">Same as Owner</td><td className="px-6 py-4 text-green-600 font-bold">Separate Entity</td></tr>
                                    <tr className="hover:bg-gray-50"><td className="px-6 py-4 font-bold text-gray-900">Liability</td><td className="px-6 py-4 text-slate font-bold bg-beige/10 text-red-500">Unlimited</td><td className="px-6 py-4 text-green-600">Limited</td></tr>
                                    <tr className="hover:bg-gray-50"><td className="px-6 py-4 font-bold text-gray-900">Registration Cost</td><td className="px-6 py-4 text-slate font-bold bg-beige/10 text-green-600">Very Low</td><td className="px-6 py-4 text-orange-500">High</td></tr>
                                    <tr className="hover:bg-gray-50"><td className="px-6 py-4 font-bold text-gray-900">Compliance</td><td className="px-6 py-4 text-slate font-bold bg-beige/10 text-green-600">Minimal</td><td className="px-6 py-4 text-orange-500">High (Audit Mandatory)</td></tr>
                                    <tr className="hover:bg-gray-50"><td className="px-6 py-4 font-bold text-gray-900">Succession</td><td className="px-6 py-4 text-slate font-bold bg-beige/10 text-red-500">Ends with Owner</td><td className="px-6 py-4 text-green-600">Nominee takes over</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            {[
                                { step: "Step 1", title: "Documents Collection", days: "Day 1", desc: "Submission of PAN, Aadhaar, and Business Address Proofs." },
                                { step: "Step 2", title: "MSME/Udyam", days: "Day 2", desc: "Registration under MSME (Udyam) to generate official government recognition." },
                                { step: "Step 3", title: "GST Registration", days: "Day 3-5", desc: "Application for GSTIN (compulsory if turnover > 40L or for interstate trade)." },
                                { step: "Step 4", title: "Business Ready", days: "Day 6", desc: "Receipt of Registration certificates. You can now open a Current Bank Account." }
                            ].map((item, i) => (
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        ...
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Aadhaar Card (Linked to Mobile)</li>
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Review of Bank Passbook</li>
                                    </ul>
                                </div>

                                <div>
                                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 border-b pb-2">Business Address</h4>
                                    <ul className="space-y-3">
                                        ...
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Property Tax Receipt (If Owned)</li>
                    ...
                    {showRegisterModal && (
                        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md p-4 animate-in fade-in duration-300">
                            <div className="relative w-full max-w-6xl max-h-[95vh] rounded-3xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 bg-white ring-1 ring-white/20 overflow-y-auto">
                                <ProprietorshipRegistration isLoggedIn={isLoggedIn} isModal={true} planProp={selectedPlan} onClose={() => setShowRegisterModal(false)} />
                            </div>
                        </div>
                    )}
                </AnimatePresence>
