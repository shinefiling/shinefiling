...
import { Repeat, Users, FileSignature, ArrowRightLeft, ShieldCheck, CheckCircle, BookOpen, Clock, Zap, HelpCircle, ChevronRight, Star, ArrowRight, UserCheck, Handshake } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import AuthModal from '../../../components/auth/AuthModal';
import ApplyTrademarkAssignment from './ApplyTrademarkAssignment';
                            ...
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative shadow-inner">
                                ...
                                <div className="flex flex-col items-center justify-center text-center mb-5 mt-2">
                                    <div className="mb-3 relative">
                                        <div className="w-14 h-14 rounded-full bg-bronze/10 flex items-center justify-center">
                                            <ArrowRightLeft size={28} className="text-bronze fill-bronze/20" strokeWidth={1.5} />
                                        </div>
                                        <div className="absolute -bottom-1 -right-1 bg-white rounded-full p-0.5 shadow-sm">
                                            <div className="bg-orange-100 rounded-full p-0.5">
                                                <FileSignature size={12} className="text-orange-500 fill-orange-100" />
                                            </div>
                                        </div>
                                    </div>
                                    <h3 className="text-navy font-bold text-2xl leading-tight">
                                        Trademark <br />Assignment
                                    </h3>
                                    <p className="text-slate-500 font-medium text-[10px] mt-1 tracking-wide uppercase">Transfer Ownership</p>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-5">
                                    ...
                                    <div className="text-center relative">
                                        ...
                                        <p className="text-slate-500 text-[10px] font-bold uppercase leading-tight">Legal <br />Transfer</p>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-slate-500 text-[10px] font-bold uppercase leading-tight">Brand <br />Protection</p>
                                    </div>
                                </div>
            ...
            <section id="pricing-plans" className="py-20 px-6 lg:px-12 bg-white relative overflow-hidden">
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 items-center">
                        ...
                        >
                            <h3 className="text-lg font-bold text-navy mb-2">Legal Consult</h3>
                        ...
                        >
                            ...
                            <div className="absolute top-4 right-4 bg-gradient-to-r from-[#ED6E3F] to-[#D4AF37] text-white text-[9px] font-bold px-3 py-1 rounded-full uppercase tracking-wider shadow-lg">Best Value</div>

                            <h3 className="text-lg font-bold text-white mb-2 mt-1">Assignment Service</h3>
                            ...
                            <button onClick={() => handlePlanSelect('assignment_service')} className="w-full py-3 bg-gradient-to-r from-bronze to-yellow-700 hover:scale-105 text-white font-bold rounded-lg shadow-lg transition-all text-sm">Start Assignment</button>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-2xl p-6 border mt-4 border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col h-full"
                        >
                            <h3 className="text-lg font-bold text-navy mb-2">Change Details</h3>
                            ...
                            <button onClick={() => handlePlanSelect('change_details')} className="w-full py-2.5 bg-slate-100 text-navy font-bold rounded-lg hover:bg-slate-200 transition-colors text-sm">Update Details</button>
                        </motion.div>
                    </div>
                </div>
            </section>
