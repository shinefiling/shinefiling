...
import {
    ...
    ArrowLeft, ArrowRight, IndianRupee, Lightbulb, AlertTriangle, FileCheck
} from 'lucide-react';
import { uploadFile, submitPatentFiling } from '../../../api';

const ApplyPatentComplete = ({ isLoggedIn }) => {
    ...
    useEffect(() => {
        ...
        if (!isReallyLoggedIn) {
            navigate('/login', { state: { from: `/services/intellectual-property/patent-complete/apply` } });
        }
    }, [isLoggedIn, navigate]);
    ...
    // Plans
    const plans = {
        standard: { title: "Complete Patent", serviceFee: 14999 },
    };

    const getTotalPrice = () => {
        return (plans[planType]?.serviceFee || 14999);
    };
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            <h3 className="font-bold text-[#2B3446] mb-4 flex items-center gap-2">
                                <FileCheck size={20} className="text-purple-600" /> COMPLETE SPECIFICATION
                            </h3>
                            ...
                            <div className="grid md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div className="p-4 border rounded-lg bg-gray-50 flex items-center gap-3">
                                    <input type="checkbox" name="requestExamination" checked={formData.requestExamination === 'TRUE'} onChange={handleInputChange} className="w-5 h-5 text-purple-600" />
                                    <div>
                                        <p className="font-bold text-purple-900 text-sm">Request Early Examination</p>
                                        <p className="text-xs text-purple-700">Recommended for faster grant.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            case 2: // Disclosures
                return (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            <h3 className="font-bold text-[#2B3446] mb-4 flex items-center gap-2">
                                <Upload size={20} className="text-purple-600" /> COMPLETE DETAILS
                            </h3>
                    ...
                    <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 animate-in zoom-in-95 text-center">
                        ...
                        <div className="max-w-xs mx-auto bg-gray-50 p-6 rounded-2xl mb-8 border border-gray-200">
                            <div className="flex justify-between items-end mb-2">
                                ...
                                <span className="text-lg font-bold text-[#2B3446]">₹14,999</span>
                            </div>
    ...
    return (
        <div className="min-h-screen bg-[#FAF5FF] pb-20 pt-24 px-4 md:px-8">
            {isSuccess ? (
                <div className="max-w-4xl mx-auto bg-white p-12 rounded-3xl shadow-xl text-center">
                    <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
                        <CheckCircle size={48} className="text-green-600" />
                    </div>
                    <h1 className="text-3xl font-black text-[#2B3446] mb-4">Complete Spec Filed!</h1>
                    <p className="text-gray-500 mb-8">
                        Your complete specification for <b>{formData.inventionTitle}</b> is being processed.
                    </p>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl font-black text-[#2B3446]">Complete Patent Filing</h1>
                        <p className="text-gray-500">File Full Specification for Grant</p>
                    </div>

                    <div className="flex flex-col lg:flex-row gap-8">
                        <div className="w-full lg:w-80 space-y-6">
                            <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm space-y-1">
                                {['Invention Details', 'Complete Spec', 'Payment'].map((step, i) => (
                            ...
                            <div className="bg-purple-50 p-4 rounded-xl border border-purple-100 text-xs text-purple-800">
                                ...
                                <span className="text-lg font-bold">Complete Filing</span>
                                <div className="mt-2 text-xl font-black text-purple-900">₹14,999</div>
