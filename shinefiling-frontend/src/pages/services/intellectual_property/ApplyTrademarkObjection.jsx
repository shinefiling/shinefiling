                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <div className="grid md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    <label className="text-xs font-bold text-gray-500 block mb-1">Objection Type</label>
                                    <select name="objectionType" value={formData.objectionType} onChange={handleInputChange} className="w-full p-3 rounded-lg border border-gray-200">
                                        <option value="SECTION_9">Section 9 (Absolute Grounds)</option>
                                        <option value="SECTION_11">Section 11 (Relative/Conflict)</option>
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <div className="mb-6 p-4 bg-red-50 rounded-xl border border-red-100">
                                <label className="flex items-center gap-3 cursor-pointer">
                                    ...
                                    <div>
                                        <span className="font-bold text-gray-800 block">Request Hearing Immediately?</span>
                                        <span className="text-xs text-gray-500">Check this to skip written arguments (Not Recommended).</span>
                                    </div>
                                </label>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                {[
                                    ...
                                    { id: 'USAGE_EVIDENCE', label: 'Usage Evidence (Bills)' }
                                ].map((doc) => (
                                    <div key={doc.id} className="border border-dashed p-6 rounded-xl text-center group hover:border-red-300 transition">
        ...
        <div className="min-h-screen bg-[#FFF5F5] pb-20 pt-24 px-4 md:px-8">
            {isSuccess ? (
                <div className="max-w-4xl mx-auto bg-white p-12 rounded-3xl shadow-xl text-center">
                    ...
                    <h1 className="text-3xl font-black text-[#2B3446] mb-4">Reply Initiated!</h1>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        <div className="w-full lg:w-80 space-y-6">
                            <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm space-y-1">
                                {['Objection Details', 'Evidence & Docs', 'Payment'].map((step, i) => (
                            ...
                            <div className="bg-red-50 p-4 rounded-xl border border-red-100 text-xs text-red-800">
                                ...
                                <div className="mt-2 text-xl font-black text-red-900">₹2,999</div>
                                <div className="text-[10px] text-red-600 mt-1 opacity-75">Flat Fee</div>
                            </div>
                        </div>
