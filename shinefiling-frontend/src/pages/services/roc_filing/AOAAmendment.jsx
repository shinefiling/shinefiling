                    ...
                    <div className="grid md:grid-cols-3 gap-8 items-start">
                        ...
                        >
                            ...
                            <ul className="space-y-3 mb-6 flex-1 text-slate-700">
                                <li className="flex gap-3 text-sm"><CheckCircle size={14} className="text-green-500 shrink-0" /> Check Feasibility</li>
                                <li className="flex gap-3 text-sm"><CheckCircle size={14} className="text-green-500 shrink-0" /> Clause Drafting Advice</li>
                            </ul>
                        ...
                        >
                            ...
                            <h3 className="text-lg font-bold text-white mb-2 mt-1">Clause Amendment</h3>
                            <div className="flex items-center gap-2 mb-4">
                            ...
                            <ul className="space-y-3 mb-6 flex-1 text-gray-200">
                                <li className="flex gap-3 text-sm"><div className="bg-bronze/20 p-1 rounded-full"><CheckCircle size={12} className="text-bronze" /></div> Edit Specific Clauses</li>
                                <li className="flex gap-3 text-sm"><div className="bg-bronze/20 p-1 rounded-full"><CheckCircle size={12} className="text-bronze" /></div> MGT-14 Filing</li>
                                <li className="flex gap-3 text-sm"><div className="bg-bronze/20 p-1 rounded-full"><CheckCircle size={12} className="text-bronze" /></div> Altered AOA Drafting</li>
                            </ul>
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-2xl p-6 border mt-4 border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col h-full"
                        >
                            <h3 className="text-lg font-bold text-navy mb-2">AOA Adoption</h3>
                            <div className="flex items-center gap-2 mb-4">
                            ...
                            <ul className="space-y-3 mb-6 flex-1 text-slate-700">
                                <li className="flex gap-3 text-sm"><CheckCircle size={14} className="text-green-500 shrink-0" /> Adopt New Table F</li>
                                <li className="flex gap-3 text-sm"><CheckCircle size={14} className="text-green-500 shrink-0" /> Legal Vetting</li>
