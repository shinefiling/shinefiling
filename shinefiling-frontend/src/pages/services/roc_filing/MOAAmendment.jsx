...
import MOAAmendmentRegistration from './MOAAmendmentRegistration';
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 items-start">
                        ...
                        >
                            ...
                            <p className="text-slate-500 text-sm mb-6">Expert Feasibility Check.</p>
                        ...
                        >
                            ...
                            <h3 className="text-lg font-bold text-white mb-2 mt-1">Object Shift</h3>
                            <p className="text-gray-400 text-sm mb-6">New Business Activities.</p>
                            <div className="flex items-center gap-2 mb-4">
                        ...
                        >
                            ...
                            <p className="text-slate-500 text-sm mb-6">New Articles 2013 Act.</p>
                            <div className="flex items-center gap-2 mb-4">
                            ...
                            <ul className="space-y-3 mb-6 flex-1 text-slate-700">
                                {[
                                    ...
                                    "Legal Vetting Of Clauses",
                                    "Special Shareholder EGM",
                                    "MGT-14 Full Filing",
                                    "Certified AOA Set"
                                ].map((feat, i) => (
                                    <li key={i} className="flex items-center gap-3 text-sm">
