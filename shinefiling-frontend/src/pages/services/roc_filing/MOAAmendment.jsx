                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 items-start">
                        ...
                        >
                            ...
                            <h3 className="text-lg font-bold text-white mb-2 mt-1">Object Change</h3>
                            <div className="flex items-center gap-2 mb-4">
                            ...
                            <ul className="space-y-3 mb-6 flex-1 text-gray-200">
                                <li className="flex gap-3 text-sm"><div className="bg-bronze/20 p-1 rounded-full"><CheckCircle size={12} className="text-bronze" /></div> Edit Business Activity</li>
                                ...
                                <li className="flex gap-3 text-sm"><div className="bg-bronze/20 p-1 rounded-full"><CheckCircle size={12} className="text-bronze" /></div> Altered MOA Drafting</li>
                            </ul>
                        ...
                        >
                            ...
                            <ul className="space-y-3 mb-6 flex-1 text-slate-700">
                                <li className="flex gap-3 text-sm"><CheckCircle size={14} className="text-green-500 shrink-0" /> Adopt New AOA (2013)</li>
