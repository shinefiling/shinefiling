        ...
        <div className="min-h-screen bg-[#F2F1EF] text-navy font-sans pb-24">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                        ...
                        >
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative">
                                <div className="absolute top-0 right-0 bg-navy text-white text-[10px] font-bold px-3 py-1 rounded-bl-xl uppercase tracking-wider z-10">Web KYC</div>
                                ...
                                >
                                    File Web KYC <ArrowRight size={18} />
                                </button>
            ...
            <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    {/* KEY BENEFITS / COMPARISON GRID */}
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-8">Which KYC is for you?</h2>
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { title: "DIR-3 KYC WEB", desc: "Applicable if you have already filed KYC in previous years and there is NO CHANGE in your personal details (Mobile/Email/Address).", icon: Globe, highlight: "OTP Based" },
                                { title: "DIR-3 KYC e-Form", desc: "Applicable if you are filing for the FIRST TIME or if you want to update your Mobile No, Email, or Address.", icon: FileText, highlight: "DSC Required" },
                            ].map((item, i) => (
                    ...
                    <section id="pricing-section">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-[#2B3446] rounded-3xl p-6 shadow-2xl relative overflow-hidden transform md:-translate-y-4 flex flex-col">
                                ...
                                <h3 className="text-xl font-bold text-white mb-2">Web Based</h3>
                                <div className="text-4xl font-black text-white mb-1">₹499</div>
                                <p className="text-xs text-gray-400 mb-6">+ GST</p>
                                <ul className="space-y-4 mb-8 flex-1">
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Web-KYC Filing</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> No Change in Details</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> OTP Verification Only</li>
                                </ul>
                                <button onClick={() => handlePlanSelect('standard')} className="w-full py-3 rounded-xl bg-gradient-to-r from-bronze to-yellow-700 text-white font-bold shadow-lg hover:shadow-yellow-500/20 transition">Select Web KYC</button>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative group flex flex-col">
                                ...
                                <button onClick={() => handlePlanSelect('premium')} className="w-full py-3 rounded-xl border-2 border-[#2B3446] text-navy font-bold hover:bg-navy hover:text-white transition">Select e-Form KYC</button>
                            </div>
                        </div>
                    </section>
