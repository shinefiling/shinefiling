...
const ShareTransferFilingPage = ({ isLoggedIn }) => {
    ...
    const faqs = [
        { q: "What is Share Transfer?", a: "It is the process of transferring existing shares from one person (Transferor) to another (Transferee)." },
        { q: "What form is used?", a: "Form SH-4 (Securities Transfer Form) is executed. No specific form is filed with ROC immediately, but it is reported in Annual Return." },
        { q: "What is Stamp Duty?", a: "Stamp duty @ 0.015% of the consideration value must be paid on share transfer deed (SH-4)." },
        { q: "Can we transfer shares to anyone?", a: "In Pvt Ltd companies, shares are restricted. Transfer usually requires Board approval and offering to existing shareholders first." },
        { q: "Documents required?", a: "Original Share Certificates, SH-4 Form duly stamped and signed, and Board Resolution." },
    ];
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            ...
                            >
                                <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-bronze/20 text-bronze border border-bronze/30 rounded-full text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-sm">
                                    <TrendingUp size={12} className="fill-bronze" /> Ownership Change
                                </span>
                            ...
                            >
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="font-bold text-sm text-white">2-3 Days</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    <div className="w-10 h-10 rounded-lg bg-bronze/20 flex items-center justify-center text-bronze">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="font-bold text-sm text-white">SH-4</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative shadow-inner">
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-5">
                                    <div className="text-center relative">
                                        ...
                                        <p className="text-slate-500 text-[10px] font-bold uppercase leading-tight">SH-4 <br />Filing</p>
                    ...
                    <div className="sticky top-32 space-y-8">
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 border-b pb-2">Parties Info</h4>
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Transferor (Seller)</li>
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Transferee (Buyer)</li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 border-b pb-2">Share Details</h4>
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> No. of Shares & Price</li>
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Original Certificate</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
