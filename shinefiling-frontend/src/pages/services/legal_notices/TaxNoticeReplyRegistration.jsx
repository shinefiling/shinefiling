            ...
            <div className="flex flex-row h-[85vh] overflow-hidden bg-white">
                ...
                <div className="w-72 bg-[#043E52] text-white flex flex-col p-6 shrink-0 relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-8">
                        <h1 className="font-bold text-lg flex items-center gap-2 tracking-tight">
                            <span className="text-[#ED6E3F]">TAX</span>
                            Reply
                        </h1>
                ...
                <div className="flex-1 flex flex-col h-full relative bg-[#F8F9FA]">
                    <div className="h-16 bg-white border-b flex items-center justify-between px-6 shrink-0 z-20">
                        <h2 className="font-bold text-navy text-lg">{['Notice Info', 'Entity Details', 'Upload', 'Review', 'Pay'][currentStep - 1]}</h2>
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <div><label className="text-xs font-bold text-gray-500 mb-1 block">Notice Section (e.g. 143(1), ASMT-10)</label>
                                    <input name="noticeSection" value={formData.noticeSection} onChange={handleInputChange} className="w-full p-3 border border-gray-200 rounded-lg" /></div>
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm animate-in fade-in slide-in-from-right-4">
                        ...
                        <div className="grid gap-4">
                            <div><label className="text-xs font-bold text-gray-500 mb-1 block">Business Name / Taxpayer Name</label>
                                <input name="businessName" value={formData.businessName} onChange={handleInputChange} className="w-full p-3 border border-gray-200 rounded-lg" /></div>
                            <div><label className="text-xs font-bold text-gray-500 mb-1 block">Assessment Year (AY)</label>
                                <input name="assessmentYear" value={formData.assessmentYear} onChange={handleInputChange} placeholder="e.g. 2024-25" className="w-full p-3 border border-gray-200 rounded-lg" /></div>
                        </div>
                    </div>
                );
            case 3:
                return (
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 text-center animate-in fade-in slide-in-from-right-4">
                        ...
                        <h3 className="font-bold mb-4 uppercase tracking-widest text-xs">UPLOAD NOTICE COPY</h3>
                        ...
                        <div className="flex-1">{renderStepContent()}
                            {!isSuccess && currentStep < 5 && (
                                <div className="mt-8 flex justify-between">
                                    <button onClick={() => setCurrentStep(p => p - 1)} disabled={currentStep === 1} className="font-bold text-gray-500 hover:text-navy transition">Back</button>
