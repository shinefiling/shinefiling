...
import {
    ...
    BookOpen, Clock, Zap, ChevronRight, Star, ArrowRight, X, Layers, Handshake
} from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import AuthModal from '../../../components/auth/AuthModal';
import StartupPitchDeckRegistration from './StartupPitchDeckRegistration';

const StartupPitchDeck = ({ isLoggedIn }) => {
    const [showRegisterModal, setShowRegisterModal] = useState(false);
    const [showAuthModal, setShowAuthModal] = useState(false);
    const [authMode, setAuthMode] = useState('login');
    const [selectedPlan, setSelectedPlan] = useState('investor');
                            ...
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative shadow-inner">
                                ...
                                <div className="flex flex-col items-center justify-center text-center mb-5 mt-2">
                                    ...
                                    <h3 className="text-navy font-bold text-2xl leading-tight">
                                        Pitch Deck <br />Investor Ready
                                    </h3>
                                    <p className="text-slate-500 font-medium text-[10px] mt-1 tracking-wide uppercase">Fundraising</p>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-5">
                                    ...
                                    <div className="text-center relative">
                                        ...
                                        <p className="text-slate-500 text-[10px] font-bold uppercase leading-tight">Visual <br />Story</p>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-slate-500 text-[10px] font-bold uppercase leading-tight">Investor <br />Impact</p>
                                    </div>
                                </div>
                                ...
                                >
                                    Create Deck <ArrowRight size={16} />
                                </button>
            ...
            <section id="pricing-plans" className="py-20 px-6 lg:px-12 bg-white relative overflow-hidden">
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 items-center">
                        ...
                        >
                            <h3 className="text-lg font-bold text-navy mb-2">Structure</h3>
                            ...
                            <button onClick={() => handlePlanSelect('structure')} className="w-full py-2.5 bg-slate-100 text-navy font-bold rounded-lg hover:bg-slate-200 transition-colors text-sm">Select Basic</button>
                        </motion.div>
                        ...
                        >
                            ...
                            <h3 className="text-lg font-bold text-white mb-2 mt-1">Investor Ready</h3>
                            ...
                            <button onClick={() => handlePlanSelect('investor')} className="w-full py-3 bg-gradient-to-r from-bronze to-yellow-700 hover:scale-105 text-white font-bold rounded-lg shadow-lg transition-all text-sm">Select Complete</button>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-2xl p-6 border mt-4 border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col h-full"
                        >
                            <h3 className="text-lg font-bold text-navy mb-2">Fundraise Bundle</h3>
                            ...
                            <button onClick={() => handlePlanSelect('bundle')} className="w-full py-2.5 bg-slate-100 text-navy font-bold rounded-lg hover:bg-slate-200 transition-colors text-sm">Select Bundle</button>
                        </motion.div>
                    </div>
                </div>
            </section>
