...
const CashFlowStatementRegistration = ({ isModal, onClose, initialData = {} }) => {
    const [searchParams] = useSearchParams();
    const navigate = useNavigate();

    // Determine initial plan
    const queryPlan = searchParams.get('plan') || initialData.plan || 'forecasting';
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            <h3 className="font-bold text-navy mb-4 flex items-center gap-2">
                                <Building size={20} className="text-blue-600" /> BUSINESS INFO
                            </h3>
                ...
                <div className="w-72 bg-[#043E52] text-white flex flex-col p-6 shrink-0 relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-8">
                        <h1 className="font-bold text-lg flex items-center gap-2 tracking-tight">
                            <span className="text-[#ED6E3F]">Cash Flow</span>
                            Mgmt.
                        </h1>
            ...
            {success ? (
                <div className="max-w-4xl mx-auto bg-white p-12 rounded-3xl shadow-xl text-center">
                    ...
                    <p className="text-gray-500 mb-8">
                        Your request for a <span className="font-bold text-navy">Cash Flow Statement</span> has been logged.
                        Reference ID: <span className="font-bold text-blue-600">{formData.submissionId}</span>.
                        Our financial analysts will review your data and send the draft within 48 hours.
                    </p>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-navy">Cash Flow Compliance</h1>
                        <p className="text-gray-500">Master your liquidity with expert reporting.</p>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="w-full lg:w-80 space-y-6">
                            ...
                            <div className={`p-6 rounded-2xl border shadow-sm ${plans[selectedPlan]?.color || 'bg-white'} relative overflow-hidden transition-all sticky top-24`}>
                                ...
                                <Activity className="absolute -bottom-8 -right-8 w-32 h-32 opacity-10 rotate-12" />
                            </div>
                        </div>
