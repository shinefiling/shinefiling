                ...
                <div className="w-72 bg-[#043E52] text-white flex flex-col p-6 shrink-0 relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-8">
                        <h1 className="font-bold text-lg flex items-center gap-2 tracking-tight">
                            <span className="text-[#ED6E3F]">Virtual</span>
                            CFO
                        </h1>
                    ...
                    <div className="flex-1 overflow-y-auto p-6 md:p-8">
                        {success ? (
                            <div className="text-center py-10">
                                ...
                                <h2 className="text-2xl font-bold text-navy">Onboarding Initiated!</h2>
                                <p className="text-gray-500 mt-2">Your booking for <span className="font-bold text-navy">{plans[selectedPlan].title}</span> has been successful.</p>
