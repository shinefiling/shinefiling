...
import {
    ...
    Save, Shield, CreditCard, Lock, Info, Award, Rocket, Building, Briefcase, X
} from 'lucide-react';
                ...
                <div className="w-72 bg-[#043E52] text-white flex flex-col p-6 shrink-0 relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-8">
                        <h1 className="font-bold text-lg flex items-center gap-2 tracking-tight">
                            <span className="text-[#ED6E3F]">Startup</span> India
                        </h1>
                        <div className="mt-4 p-3 bg-white/10 rounded-lg border border-white/10 backdrop-blur-sm">
                            <p className="text-[10px] uppercase text-blue-200 tracking-wider mb-1">Package</p>
        ...
        <div className="min-h-screen bg-[#F8F9FA] pb-20 pt-24 px-4 md:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="mb-8 pl-1">
                    ...
                    <h1 className="text-3xl font-bold text-navy">Startup India Registration</h1>
                    <p className="text-gray-500">Get recognized by DPIIT and avail tax benefits.</p>
                </div>
                    ...
                    <div className="w-full lg:w-80 space-y-6">
                        ...
                        <div className="p-6 rounded-2xl border shadow-sm bg-[#043E52] text-white relative overflow-hidden transition-all sticky top-24">
                            <div className="relative z-10">
                                <div className="text-xs font-bold opacity-70 uppercase tracking-widest mb-1">Selected Package</div>
                                ...
                                <div className="space-y-3 mb-6">
                                    <div className="flex gap-2 text-xs font-medium opacity-80"><CheckCircle size={14} /> DPIIT Recognition</div>
                                    <div className="flex gap-2 text-xs font-medium opacity-80"><CheckCircle size={14} /> Tax Benefits</div>
                                    <div className="flex gap-2 text-xs font-medium opacity-80"><CheckCircle size={14} /> Gov. Tenders</div>
                                </div>
                            </div>
                            <Rocket className="absolute -bottom-8 -right-8 w-32 h-32 opacity-10 rotate-12" />
                        </div>
                    </div>
