...
import {
    ...
    Save, Shield, CreditCard, Lock, HelpCircle, Info, Award, User, MapPin, Briefcase, X
} from 'lucide-react';
    ...
    const validateStep = (currentStep) => {
        ...
        switch (currentStep) {
            ...
            case 2: // Detailed Info
                ...
                if (plan.includes('tan') && !formData.businessName) return "Business/Entity Name is required for TAN.";
                return null;
            case 3: // Documents
                if (!documents.aadhaarCard) return "Aadhaar Card upload is mandatory.";
                if (!documents.photo) return "Passport Photo is mandatory.";
                if (plan.includes('tan') && !documents.incorporationCert && formData.entityType !== 'Individual') return "Business Proof is required for TAN.";
                return null;
            default:
                return null;
        }
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            {plan.includes('tan') && (
                                <div className="mt-6 pt-6 border-t border-gray-100">
                                    <h3 className="font-bold text-navy mb-4 flex items-center gap-2">
                                        <Briefcase size={20} className="text-purple-600" /> BUSINESS DETAILS (For TAN)
                                    </h3>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-1">
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {[
                                    ...
                                    plan.includes('tan') && formData.entityType !== 'Individual' ? { id: 'incorporationCert', label: 'Incorp Certificate / Deed', required: true } : null
                ...
                <div className="w-72 bg-[#043E52] text-white flex flex-col p-6 shrink-0 relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-8">
                        <h1 className="font-bold text-lg flex items-center gap-2 tracking-tight">
                            <span className="text-[#ED6E3F]">PAN / TAN</span> Services
                        </h1>
                        <div className="mt-4 p-3 bg-white/10 rounded-lg border border-white/10 backdrop-blur-sm">
                            <p className="text-[10px] uppercase text-blue-200 tracking-wider mb-1">Service</p>
        ...
        <div className="min-h-screen bg-[#F8F9FA] pb-20 pt-24 px-4 md:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="mb-8 pl-1">
                    ...
                    <h1 className="text-3xl font-bold text-navy">PAN & TAN Corrections</h1>
                    <p className="text-gray-500">Apply for new PAN/TAN or make corrections easily.</p>
                </div>
                    ...
                    <div className="w-full lg:w-80 space-y-6">
                        ...
                        <div className="p-6 rounded-2xl border shadow-sm bg-[#043E52] text-white relative overflow-hidden transition-all sticky top-24">
                            <div className="relative z-10">
                                <div className="text-xs font-bold opacity-70 uppercase tracking-widest mb-1">Selected Service</div>
                                ...
                                <div className="space-y-3 mb-6">
                                    <div className="flex gap-2 text-xs font-medium opacity-80"><CheckCircle size={14} /> Online Application</div>
                                    <div className="flex gap-2 text-xs font-medium opacity-80"><CheckCircle size={14} /> Doorstep Delivery</div>
                                </div>
                            </div>
                            <CreditCard className="absolute -bottom-8 -right-8 w-32 h-32 opacity-10 rotate-12" />
                        </div>
                    </div>
