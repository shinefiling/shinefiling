...
import {
    ...
    Save, Shield, CreditCard, Lock, Info, Award, Smartphone, User, MapPin, Key, X
} from 'lucide-react';
                ...
                <div className="w-72 bg-[#043E52] text-white flex flex-col p-6 shrink-0 relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-8">
                        <h1 className="font-bold text-lg flex items-center gap-2 tracking-tight">
                            <span className="text-[#ED6E3F]">Class 3</span> DSC
                        </h1>
        ...
        <div className="min-h-screen bg-[#F8F9FA] pb-20 pt-24 px-4 md:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="mb-8 pl-1">
                    ...
                    <h1 className="text-3xl font-bold text-navy">Digital Signature (DSC)</h1>
                    <p className="text-gray-500">Class 3 Signing + Encryption with USB Token.</p>
                </div>
                        ...
                        <div className="p-6 rounded-2xl border shadow-sm bg-[#043E52] text-white relative overflow-hidden transition-all sticky top-24">
                            <div className="relative z-10">
                                ...
                                <div className="space-y-3 mb-6">
                                    <div className="flex gap-2 text-xs font-medium opacity-80"><CheckCircle size={14} /> USB Token Included</div>
                                    <div className="flex gap-2 text-xs font-medium opacity-80"><CheckCircle size={14} /> Video Verification</div>
                                    <div className="flex gap-2 text-xs font-medium opacity-80"><CheckCircle size={14} /> 2-3 Years Validity</div>
                                </div>
                            </div>
                            <Key className="absolute -bottom-8 -right-8 w-32 h-32 opacity-10 rotate-12" />
                        </div>
                    </div>
