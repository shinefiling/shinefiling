        ...
        <div className="min-h-screen bg-[#F2F1EF] text-navy font-sans pb-24">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                        ...
                        >
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative">
                                ...
                                >
                                    Register GST <ArrowRight size={18} />
                                </button>
            ...
            <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        ...
                        <div className="prose prose-lg text-gray-600">
                            <p className="lead text-xl text-gray-800 font-medium">
                                <strong>Goods and Services Tax (GST)</strong> is a unified tax system in India that replaced multiple indirect taxes. GST Registration is mandatory for any business whose turnover exceeds the prescribed threshold limit.
                            </p>
                            <p>
                                It is also required for businesses selling goods online via aggregators (like Amazon, Flipkart, Zomato) or those involved in inter-state supply of goods, regardless of turnover.
                            </p>
                        </div>
                    </section>
                    ...
                    {/* PRICING PLANS SECTION - Keeping this as GST offers defined plans */}
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative group flex flex-col">
                                ...
                                <ul className="space-y-3 mb-8 flex-1">
                                    ...
                                    <li className="flex gap-3 text-sm text-slate-300"><X size={16} className="shrink-0" /> Return Filing</li>
                                </ul>
                            ...
                            <div className="bg-[#2B3446] rounded-3xl p-6 shadow-2xl relative overflow-hidden transform md:-translate-y-4 flex flex-col">
                                ...
                                <ul className="space-y-3 mb-8 flex-1">
                                    ...
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> ARN Generation</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Certificate Download</li>
                                </ul>
                            ...
                            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative group flex flex-col">
                                ...
                                <ul className="space-y-3 mb-8 flex-1">
                                    ...
                                    <li className="flex gap-3 text-sm text-gray-600"><CheckCircle size={16} className="text-bronze shrink-0" /> 3 Months Return Filing</li>
                                    <li className="flex gap-3 text-sm text-gray-600"><CheckCircle size={16} className="text-bronze shrink-0" /> Invoicing Software</li>
                                    <li className="flex gap-3 text-sm text-gray-600"><CheckCircle size={16} className="text-bronze shrink-0" /> Dedicated CA Support</li>
                                </ul>
                    ...
                    <section>
                        ...
                        <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-sm">
                            ...
                            <div className="divide-y divide-gray-100">
                                {[
                                    { name: "GST Registration Certificate", type: "Form REG-06" },
                                    { name: "GSTIN Number", type: "15 Digit ID" },
                                    { name: "Login Credentials", type: "For GST Portal" },
                                    { name: "HSN/SAC Codes List", type: "For Invoicing" },
                                    { name: "Invoicing Guidelines", type: "Expert Support" }
                                ].map((row, i) => (
                                    <div key={i} className="flex flex-col md:flex-row md:items-center justify-between p-6 hover:bg-gray-50 transition">
                                        ...
                                        <div className="md:w-1/3 mt-2 md:mt-0 text-right">
                                            <span className="inline-block px-3 py-1 rounded-full text-xs font-bold bg-beige/30 text-bronze-dark">
                                                {row.type}
                                            </span>
                                        </div>
                                    </div>
