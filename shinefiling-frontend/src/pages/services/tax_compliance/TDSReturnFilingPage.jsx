...
const TDSReturnFilingPage = ({ isLoggedIn, onLogout }) => {
    ...
    const faqs = [
        { q: "What are the types of TDS Returns?", a: "Form 24Q (Salary), 26Q (Other than Salary), 27Q (NRI Payments)." },
        { q: "What is the due date?", a: "Quarterly: 31st July, 31st Oct, 31st Jan, 31st May." },
        { q: "Is Late Fee applicable?", a: "Yes, ₹200 per day under section 234E for late filing." },
        { q: "Do I need a TAN?", a: "Yes, Tax Deduction and Collection Account Number (TAN) is mandatory for filing TDS returns." }
    ];
    ...
    const handlePlanSelect = (plan) => {
        if (isLoggedIn) {
            ...
            const targetUrl = `/services/tds-return/register?plan=${plan}`;
        ...
        <div className="min-h-screen bg-[#F2F1EF] text-navy font-sans pb-24">
            ...
            <div className="relative min-h-[85vh] flex items-center pt-32 pb-20 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <img src="https://images.unsplash.com/photo-1563986768494-4dee46a38569?auto=format&fit=crop&q=80&w=2070" className="w-full h-full object-cover" alt="TDS" />
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                                <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-bronze/20 text-bronze border border-bronze/30 rounded-full text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-sm"><Zap size={12} className="text-bronze" /> Tax Deduction at Source</span>
                                <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-4 text-white tracking-tight">
                                    TDS Return <br />
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-bronze to-white">Filing Compliance</span>
                                </h1>
                                <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                                    File your Quarterly TDS Returns (24Q, 26Q) on time. Avoid late fees and notices. We handle data preparation, FVU validation, and upload.
                                </p>
                            </motion.div>
                            ...
                            >
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="font-bold text-sm text-white">Every Quarter</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    <div className="w-10 h-10 rounded-lg bg-bronze/20 flex items-center justify-center text-bronze">
                                    ...
                                    <div className="text-left">
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Report</p>
                                        <p className="font-bold text-sm text-white">Form 16A Issued</p>
                                    </div>
                                </div>
                            </motion.div>
                        ...
                        >
                             <div className="bg-white rounded-[20px] p-6 overflow-hidden relative shadow-inner">
                                ...
                                <div className="flex flex-col items-center justify-center text-center mb-5 mt-2">
                                    ...
                                    <p className="text-slate-500 font-medium text-[10px] mt-1 tracking-wide uppercase">T D S Return Filing</p>
                                </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 items-center">
                        ...
                        >
                            ...
                            <button onClick={() => handlePlanSelect('correction')} className="w-full py-3 bg-slate-100 text-navy font-bold rounded-xl hover:bg-slate-200 transition-colors">
                                Select Correction
                            </button>
                        </motion.div>
                    </div>
                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6 flex items-center gap-3">
                            <Zap className="text-bronze" /> What is TDS Return?
                        </h2>
                        <div className="prose prose-lg text-gray-600">
                            <p className="lead text-xl text-gray-800 font-medium">
                                <strong>Tax Deducted at Source (TDS) Return</strong> is a quarterly statement that every deductor must file to the Income Tax Department. It contains details of TDS deducted and deposited by you.
                            </p>
                            <p>
                                <strong>Crucial Responsibility:</strong> If you are making specified payments like Salary, Rent, Professional Fees, or Commission, you must deduct TDS and file returns so that the deductee gets the tax credit in their Form 26AS.
                            </p>
                        </div>
                    </section>
                    ...
                    {/* BENEFITS GRID */}
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-8">Why Timely Filing is Critical?</h2>
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { title: "Avoid ₹200/Day Fee", desc: "Late filing attracts a mandatory late fee of ₹200 for every single day of delay.", icon: Clock },
                                { title: "Avoid Penalty 271H", desc: "Non-filing or incorrect filing can attract a penalty ranging from ₹10,000 to ₹1,00,000.", icon: Shield },
                                { title: "Credit to Payee", desc: "Your employees/vendors won't get tax credit if you don't file, leading to disputes.", icon: CheckCircle },
                                { title: "Easy Correction", desc: "Timely original filing makes it easier to file correction returns if any error is found later.", icon: FileText },
                            ].map((benefit, i) => (
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-8">TDS Return Filing Process</h2>
                        <div className="space-y-6">
                            {[
                                { step: "Step 1", title: "Deduct TDS", desc: "Deduct tax at source while making payments to employees or vendors as per the applicable rates." },
                                { step: "Step 2", title: "Deposit TDS (Payment)", desc: "Deposit the deducted amount to the government via Challan 281 by the 7th of the next month." },
                                { step: "Step 3", title: "Prepare Return", desc: "Consolidate all challan and deductee details. Our software generates the FVU file validated by NSDL." },
                                { step: "Step 4", title: "File & Issue Certificates", desc: "Upload the FVU file on the IT portal. Once processed, generate Form 16/16A for deductees." },
                            ].map((item, i) => (
                    ...
                    {/* TDS FORMS TABLE */}
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-8">TDS Forms & Due Dates</h2>
                            ...
                            <table className="w-full text-left border-collapse rounded-2xl overflow-hidden shadow-sm">
                                <thead>
                                    <tr className="bg-navy text-white">
                                        ...
                                        <th className="p-4 text-sm font-bold uppercase tracking-wider">Purpose</th>
                                        <th className="p-4 text-sm font-bold uppercase tracking-wider">Frequency</th>
                                        <th className="p-4 text-sm font-bold uppercase tracking-wider">Due Date (Q1/Q2/Q3/Q4)</th>
                                    </tr>
                                </thead>
                                <tbody className="bg-white divide-y divide-gray-100">
                                    {[
                                        { f: "Form 24Q", r: "TDS on Salary", c: "Quarterly", d: "Jul 31 / Oct 31 / Jan 31 / May 31" },
                                        { f: "Form 26Q", r: "TDS on Other payments (Rent/Prof/Comm)", c: "Quarterly", d: "Jul 31 / Oct 31 / Jan 31 / May 31" },
                                        { f: "Form 27Q", r: "Payments to NRIs", c: "Quarterly", d: "Jul 31 / Oct 31 / Jan 31 / May 31" },
                                        { f: "Form 26QB", r: "Sale of Property > 50L", c: "Per Transaction", d: "30 days from month end" },
                                    ].map((row, i) => (
                                        <tr key={i} className="hover:bg-gray-50 transition">
                                            ...
                                            <td className="p-4 text-slate-600 border-r border-gray-100">{row.c}</td>
                    ...
                    {/* TDS RATE CARD TABLE */}
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6">Popular TDS Rates (FY 24-25)</h2>
                            ...
                            <table className="w-full text-left">
                                <thead className="bg-[#10232A] text-white">
                                    <tr>
                                        ...
                                        <th className="p-4 font-semibold text-sm uppercase tracking-wider">Nature of Payment</th>
                                        <th className="p-4 font-semibold text-sm uppercase tracking-wider">TDS Rate</th>
                                        <th className="p-4 font-semibold text-sm uppercase tracking-wider">Threshold</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-100">
                                    <tr className="hover:bg-gray-50 transition">
                                        <td className="p-4 text-navy font-medium">192</td>
                                        <td className="p-4 text-gray-600">Salary</td>
                                        <td className="p-4 text-gray-600">Slab Rates</td>
                                        <td className="p-4 text-gray-600">Basic Exemption Limit</td>
                                    </tr>
                                    <tr className="hover:bg-gray-50 transition">
                                        <td className="p-4 text-navy font-medium">194C</td>
                                        <td className="p-4 text-gray-600">Contractors</td>
                                        <td className="p-4 text-gray-600">1% (Indiv) / 2% (Other)</td>
                                        <td className="p-4 text-gray-600">₹30k single / ₹1L agg.</td>
                                    </tr>
                                    <tr className="hover:bg-gray-50 transition">
                                        <td className="p-4 text-navy font-medium">194J</td>
                                        <td className="p-4 text-gray-600">Professional Fees</td>
                                        <td className="p-4 text-gray-600">10% (Tech/Royalty: 2%)</td>
                                        <td className="p-4 text-gray-600">₹30,000 p.a.</td>
                                    </tr>
                                    <tr className="hover:bg-gray-50 transition">
                                        <td className="p-4 text-navy font-medium">194H</td>
                                        <td className="p-4 text-gray-600">Commission</td>
                                        <td className="p-4 text-gray-600">5%</td>
                                        <td className="p-4 text-gray-600">₹15,000 p.a.</td>
                                    </tr>
                                </tbody>
                            </table>
                            <div className="p-4 bg-red-50 text-red-800 text-sm border-t border-red-100 flex gap-2 items-center">
                                <Shield size={16} /> <strong>Note:</strong> TDS rates are 20% if PAN is not provided by the deductee.
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="grid md:grid-cols-2 gap-8 relative z-10">
                            <div className="space-y-4">
                                <div className="flex gap-4">
                                    ...
                                    <div><h4 className="font-bold text-lg">Bulk Data Handling</h4><p className="text-gray-300 text-sm">Whether you have 5 employees or 500, our system processes bulk data seamlessly.</p></div>
                                </div>
                                <div className="flex gap-4">
                                    ...
                                    <div><h4 className="font-bold text-lg">FVU Validation</h4><p className="text-gray-300 text-sm">We run your data through the latest NSDL validation utility to ensure zero errors.</p></div>
                                </div>
                            </div>
                            <div className="space-y-4">
                                <div className="flex gap-4">
                                    <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center text-bronze shrink-0"><Users size={24} /></div>
                                    <div><h4 className="font-bold text-lg">Form 16 Issuance</h4><p className="text-gray-300 text-sm">We help you generate and distribute Form 16/16A certificates to deductees.</p></div>
                                </div>
                                <div className="flex gap-4">
                                    <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center text-bronze shrink-0"><Shield size={24} /></div>
                                    <div><h4 className="font-bold text-lg">Notice Management</h4><p className="text-gray-300 text-sm">Received a Traces notice? We help you resolve defaults and file corrections.</p></div>
                                </div>
                            </div>
                        </div>
                    </section>
                ...
                <div className="lg:col-span-4">
                    <div className="sticky top-32 space-y-8">
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 border-b pb-2">DATA REQUIRED</h4>
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> TAN Number Login</li>
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Challan (BSR Code, Date)</li>
                        ...
                        <div className="bg-[#2B3446] text-white p-6 rounded-3xl shadow-lg">
                            <h4 className="font-bold text-lg mb-2">TDS Rate Query?</h4>
                            <p className="text-gray-300 text-sm mb-4">Unsure what % to deduct?</p>
