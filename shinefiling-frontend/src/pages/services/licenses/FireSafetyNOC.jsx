...
import { Flame, Shield, CheckCircle, FileText, Building, Heart, Scale, BookOpen, Clock, Zap, HelpCircle, ChevronRight, Star, ArrowRight, UserCheck, AlertTriangle, Briefcase, Users } from 'lucide-react';
...
const FireSafetyNOCPage = ({ isLoggedIn }) => {
    ...
    const handlePlanSelect = (plan) => {
        const url = `/services/licenses/fire-safety-noc/apply?plan=${plan}`;
                        ...
                        >
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative">
                                ...
                                <div className="text-center mb-6">
                                    <h3 className="text-navy font-bold text-xl mb-2">New NOC</h3>
                                    <div className="flex justify-center items-end gap-2 mb-2">
                                        <h3 className="text-5xl font-black text-navy tracking-tight">₹14,999</h3>
                                        <span className="text-lg text-slate-400 font-medium">/ NOC</span>
                                    </div>
                                    <p className="text-xs text-slate-500 font-semibold uppercase tracking-wide">+ Govt Fees</p>
                                </div>
                                <div className="space-y-4 mb-8 flex-1">
                                    {["Online Application Filing", "Building Plan Scrutiny", "Liaison for Inspection", "System Adequacy Check", "Final NOC Issuance"].map((item, i) => (
                    ...
                    <section id="pricing-plans" className="bg-white relative overflow-hidden rounded-3xl p-8 border border-gray-100 shadow-sm mb-20">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-[#10232A] rounded-3xl p-6 shadow-2xl relative overflow-hidden transform md:-translate-y-6 flex flex-col">
                                ...
                                <h3 className="text-xl font-bold text-white mb-2 mt-4">Provisional NOC</h3>
                                ...
                                <ul className="space-y-3 mb-8 flex-1">
                                    <li className="flex gap-3 text-sm text-gray-200"><div className="bg-bronze/20 p-1 rounded-full"><CheckCircle size={14} className="text-bronze" /></div> Drawing Review</li>
                                    ...
                                    <li className="flex gap-3 text-sm text-gray-200"><div className="bg-bronze/20 p-1 rounded-full"><CheckCircle size={14} className="text-bronze" /></div> Dept Follow-up</li>
                                </ul>
                                <button onClick={() => document.getElementById('pricing-plans').scrollIntoView({ behavior: 'smooth' })} className="w-full py-4 bg-gradient-to-r from-bronze to-yellow-700 hover:from-yellow-600 hover:to-yellow-800 text-white font-bold rounded-xl shadow-lg shadow-bronze/20 transition-all hover:scale-105">Select Provisional</button>
                            </div>

                            {/* Manufacturing */}
                            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative group flex flex-col">
                                <h3 className="text-xl font-bold text-navy mb-2">Final NOC</h3>
                                <div className="text-4xl font-black text-navy mb-1">₹14,999</div>
                                <p className="text-xs text-slate-400 mb-6">+ Govt Fees</p>
                                <ul className="space-y-3 mb-8 flex-1">
                                    <li className="flex gap-3 text-sm text-gray-600"><CheckCircle size={16} className="text-bronze shrink-0" /> Site Inspection</li>
                                    <li className="flex gap-3 text-sm text-gray-600"><CheckCircle size={16} className="text-bronze shrink-0" /> Equipment Check</li>
                                    <li className="flex gap-3 text-sm text-gray-600"><CheckCircle size={16} className="text-bronze shrink-0" /> Certification</li>
                                </ul>
                                <button onClick={() => document.getElementById('pricing-plans').scrollIntoView({ behavior: 'smooth' })} className="w-full py-3 rounded-xl border-2 border-[#2B3446] text-navy font-bold hover:bg-navy hover:text-white transition">Select Final</button>
                            </div>
                        </div>
                    </section>
