...
const GumasthaLicensePage = ({ isLoggedIn }) => {
    ...
    const handleApply = () => {
        const url = `/services/licenses/gumastha-license/apply`;
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            ...
                            >
                                <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-bronze/20 text-bronze border border-bronze/30 rounded-full text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-sm">
                                    <Store size={12} className="fill-bronze" /> Maharashtra Shop Act
                                </span>
                                ...
                                <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                                    Mandatory state registration for every shop, office, or commercial establishment in Maharashtra. Essential for opening a Current Bank Account.
                                </p>
                            </motion.div>
                            ...
                            >
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="font-bold text-sm text-white">Shops & Offices</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    <div className="w-10 h-10 rounded-lg bg-bronze/20 flex items-center justify-center text-bronze">
                                    ...
                                    <div className="text-left">
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Jurisdiction</p>
                        ...
                        >
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative">
                                ...
                                <div className="space-y-4 mb-8">
                                    {["Municipal Filing", "Form F (Intimation)", "Govt Fees Payment", "Challan Generation", "Certificate Issue"].map((item, i) => (
                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6 flex items-center gap-3">
                            <Building className="text-bronze" /> What is Gumastha License?
                        </h2>
                        <div className="prose prose-lg text-gray-600">
                            <p className="lead text-xl text-gray-800 font-medium">
                                Gumastha License is a state-level registration required given by the Municipal Corporation of Mumbai or other Maharashtra municipal bodies.
                            </p>
                            <p>
                                It is mandatory for any commercial establishment (shop, office, clinic, workshop) to operate legally. It serves as proof of legal entity which gives you the right to do business in the state.
                            </p>
                        </div>
                    </section>
                    ...
                    {/* BENEFITS GRID */}
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-8">Why do you need it?</h2>
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { title: "Legal Proof", desc: "Valid proof of business existence for banks.", icon: Shield },
                                { title: "Govt Benefits", desc: "Avail subsidies or loans for small businesses.", icon: Store },
                                { title: "Current Account", desc: "Mandatory document for opening a bank account.", icon: UserCheck },
                                { title: "Compliance", desc: "Avoid penalties from labor inspectors.", icon: ClipboardList },
                            ].map((item, i) => (
                    ...
                    <div className="sticky top-32 space-y-8">
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 border-b pb-2">Identity</h4>
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> PAN & Aadhaar (Owner)</li>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        ...
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Scanned Signatures</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
