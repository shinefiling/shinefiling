                        ...
                        >
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative shadow-inner">
                                ...
                                <div className="flex flex-col items-center justify-center text-center mb-5 mt-2">
                                    ...
                                    <h3 className="text-navy font-bold text-2xl leading-tight">Official <br />Gumastha License</h3>
                                    <p className="text-slate-500 font-medium text-[10px] mt-1 tracking-wide uppercase">Maharashtra State Legal</p>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-5">
                                    <div className="text-center relative">
                                        ...
                                        <p className="text-slate-500 text-[10px] font-bold uppercase leading-tight">Lifetime <br />Valid</p>
                                        <div className="absolute right-0 top-2 bottom-2 w-px bg-slate-100"></div>
                                    </div>
                                    <div className="text-center">
                                        <div className="flex items-center justify-center gap-1 mb-1">
                                            <Building size={14} className="text-bronze" />
                                            <span className="text-navy text-xl font-black tracking-tighter">Bank</span>
                                        </div>
                                        <p className="text-slate-500 text-[10px] font-bold uppercase leading-tight">Bank a/c <br />Ready</p>
                                    </div>
                                </div>
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="mt-4 text-slate-500 max-w-2xl mx-auto">
                            Mandatory state registration for every shop, office, or commercial establishment in Maharashtra.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <h3 className="text-lg font-bold text-white mb-2 mt-1">Shop Act Intimation</h3>
                            <div className="flex items-center gap-2 mb-4">
                            ...
                            <button onClick={handleApply} className="w-full py-3 bg-gradient-to-r from-bronze to-yellow-700 hover:scale-105 text-white font-bold rounded-lg shadow-lg transition-all text-sm uppercase tracking-wider">Select Standard</button>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-2xl p-6 border mt-4 border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col h-full"
                        >
                            <h3 className="text-lg font-bold text-navy mb-2">Full Registration</h3>
                            <div className="flex items-center gap-2 mb-4">
                            ...
                            <ul className="space-y-3 mb-6 flex-1 text-slate-700">
                                <li className="text-xs font-bold text-navy uppercase tracking-wider border-b border-gray-100 pb-2">Large Establishments +</li>
                                {[
                                    "Labour Dept Liaison",
                                    "Form B Certificate",
                            ...
                            <button onClick={handleApply} className="w-full py-2.5 bg-slate-100 text-navy font-bold rounded-lg hover:bg-slate-200 transition-colors text-sm uppercase">Select Premium</button>
                        </motion.div>
                    </div>
                </div>
            </section>
