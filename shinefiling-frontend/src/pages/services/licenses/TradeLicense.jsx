...
import { ArrowLeft, Clock, CheckCircle, FileText, Shield, Zap, HelpCircle, ChevronRight, BookOpen, Building, Briefcase, MapPin, Store, Utensils, Factory, Truck, AlertTriangle, Star, ArrowRight, Users, X } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import TradeLicenseRegistration from './TradeLicenseRegistration';
import AuthModal from '../../../components/auth/AuthModal';

const TradeLicensePage = ({ isLoggedIn }) => {
    const navigate = useNavigate();
    const [showRegistrationModal, setShowRegistrationModal] = useState(false);
    const [selectedPlan, setSelectedPlan] = useState('new');
    ...
    const faqs = [
        { q: "What is a Trade License?", a: "A trade license is a certificate issued by the municipal corporation that permits the applicant to carry out a specific trade or business at a particular premise." },
        { q: "Is Trade License mandatory?", a: "Yes, under the Municipal Corporation Act, every business operating within municipal limits must obtain a Trade License. Operating without one can lead to heavy fines." },
        { q: "What is the validity of a Trade License?", a: "Usually, a Trade License is valid for 1 year (April to March). It must be renewed annually between January 1st and March 31st." },
        { q: "Difference between Trade License & Shop Act?", a: "Shop Act (Gumasta) regulates working conditions (hours, wages) of employees. Trade License regulates the 'Trade' itself to ensure public health & safety." },
        { q: "Can I use a residential place for Trade License?", a: "Generally, Trade Licenses are issued for commercial zones. However, for 'Low Noise/No Nuisance' trades, some municipalities allow it with a NOC." },
    ];
        ...
        <div className="min-h-screen bg-[#F2F1EF] text-navy font-sans pb-24">
            ...
            <div className="relative min-h-[85vh] flex items-center pt-32 pb-20 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        src="https://images.unsplash.com/photo-1599583162799-a8c655079a32?auto=format&fit=crop&q=80&w=2070"
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            ...
                            >
                                <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-bronze/20 text-bronze border border-bronze/30 rounded-full text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-sm">
                                    <Building size={12} className="fill-bronze" /> Municipal Compliance
                                </span>
                                ...
                                <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                                    Secure your permission to operate commercially. Mandatory for Shops, Factories, and Establishments within city limits to ensure public health and safety.
                                </p>
                            </motion.div>
                            ...
                            >
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="font-bold text-sm text-white">Municipal Corp</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md pr-6 pl-4 py-3 rounded-xl border border-white/10">
                                    <div className="w-10 h-10 rounded-lg bg-bronze/20 flex items-center justify-center text-bronze">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="font-bold text-sm text-white">1 Year (Renewable)</p>
                                    </div>
                                </div>
                            </motion.div>
                        ...
                        >
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative shadow-inner">
                                ...
                                <div className="flex flex-col items-center justify-center text-center mb-5 mt-2">
                                    ...
                                    <h3 className="text-navy font-bold text-2xl leading-tight">Official <br />Trade License</h3>
                                    <p className="text-slate-500 font-medium text-[10px] mt-1 tracking-wide uppercase">Municipal Corporation Permit</p>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-5">
                                    <div className="text-center relative">
                                        <div className="flex items-center justify-center gap-1 mb-1">
                                            ...
                                            <span className="text-navy text-xl font-black tracking-tighter">Valid</span>
                                        </div>
                                        <p className="text-slate-500 text-[10px] font-bold uppercase leading-tight">Local Govt <br />Approved</p>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-slate-500 text-[10px] font-bold uppercase leading-tight">Paperless <br />Process</p>
                                    </div>
                                </div>
                                <div className="space-y-3 mb-6 pl-2">
                                    {[
                                        "Municipal Approval Aid",
                                        "Health Dept Liaison",
                                        "Digital Certificate Pack"
                                    ].map((item, i) => (
                                ...
                                >
                                    Get Trade License <ArrowRight size={16} />
                                </button>
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="mt-4 text-slate-500 max-w-2xl mx-auto">
                            Ensure your business operations are fully compliant with municipal regulations.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <ul className="space-y-3 mb-6 flex-1 text-slate-700">
                                {[
                                    ...
                                    "Trade Category Audit",
                                    "Affidavit Prep Help",
                                    "NOC Requirement Guide",
                                    "Penalty Audit"
                                ].map((feat, i) => (
                        ...
                        >
                            ...
                            <h3 className="text-lg font-bold text-white mb-2 mt-1">New Trade License</h3>
                            <div className="flex items-center gap-2 mb-4">
                            ...
                            <button onClick={() => handlePlanSelect('new')} className="w-full py-3 bg-gradient-to-r from-bronze to-yellow-700 hover:scale-105 text-white font-bold rounded-lg shadow-lg transition-all text-sm">Get License</button>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-2xl p-6 border mt-4 border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col h-full"
                        >
                            <h3 className="text-lg font-bold text-navy mb-2">Annual Renewal</h3>
                            ...
                            <button onClick={() => handlePlanSelect('renewal')} className="w-full py-2.5 bg-slate-100 text-navy font-bold rounded-lg hover:bg-slate-200 transition-colors text-sm">Choose Renewal</button>
                        </motion.div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> ID Proof of Partner/Director</li>
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Address Proof of Business</li>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        ...
                                        <li className="flex gap-3 text-sm text-gray-700"><CheckCircle size={16} className="text-bronze flex-shrink-0 mt-0.5" /> Fire NOC (if applicable)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
