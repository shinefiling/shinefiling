...
const TradeLicensePage = ({ isLoggedIn }) => {
    ...
    const handlePlanSelect = (plan) => {
        const url = `/services/licenses/trade-license/apply?plan=${plan}`;
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                        ...
                        >
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative">
                                <div className="absolute top-0 right-0 bg-navy text-white text-[10px] font-bold px-3 py-1 rounded-bl-xl uppercase tracking-wider z-10">All Inclusive</div>
