        ...
        <div className="min-h-screen bg-[#F2F1EF] text-navy font-sans pb-24">
            ...
            <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        ...
                        <div className="prose prose-lg text-gray-600">
                            <p className="lead text-xl text-gray-800 font-medium">
                                No business can import or export goods without an IEC Code. It is linked to your PAN and has lifetime validity, requiring no renewal (only annual update).
                            </p>
                            <p>
                                The IEC is issued by the Directorate General of Foreign Trade (DGFT), Ministry of Commerce and Industries, Government of India.
                            </p>
                        </div>
                    </section>
                    ...
                    {/* BENEFITS GRID */}
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-8">Why Get IEC?</h2>
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { title: "Global Expansion", desc: "Unlock international markets for your products and services.", icon: Globe },
                                { title: "Export Incentives", desc: "Claim refunds and benefits from DGFT & Customs under various schemes.", icon: DollarSign },
                                { title: "No Renewal", desc: "Valid for lifetime unless cancelled or surrendered.", icon: Shield },
                                { title: "Easy Processing", desc: "Completely online process with no physical document submission.", icon: Truck },
                            ].map((item, i) => (
                    ...
                    <section id="pricing-plans">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-[#2B3446] rounded-3xl p-6 shadow-2xl relative overflow-hidden transform md:-translate-y-4 flex flex-col">
                                ...
                                <h3 className="text-xl font-bold text-white mb-2">Standard IEC</h3>
                                ...
                                <ul className="space-y-3 mb-8 flex-1">
                                    ...
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> IEC Certificate</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Basic Modification</li>
                                </ul>
                            ...
                            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative group flex flex-col">
                                ...
                                <button onClick={() => navigate('/services/registration/gst-registration')} className="w-full py-3 rounded-xl border-2 border-[#2B3446] text-navy font-bold hover:bg-navy hover:text-white transition">Select Combo</button>
                            </div>
                        </div>
                    </section>
