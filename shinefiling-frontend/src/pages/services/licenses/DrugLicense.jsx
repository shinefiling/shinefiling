                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                        ...
                        >
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative">
                                ...
                                >
                                    Start Pharmacy <ArrowRight size={18} />
                                </button>
                            </div>
                        </motion.div>
                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6 flex items-center gap-3">
                            <BookOpen className="text-bronze" /> Pharmacy Business
                        </h2>
                        <div className="prose prose-lg text-gray-600">
                            ...
                            <p>
                                A valid Drug License is the most critical requirement to open a chemist shop (Retail) or distribution agency (Wholesale). It ensures that drugs are handled by qualified personnel (Pharmacists) and stored properly.
                            </p>
                        </div>
                    </section>
                    ...
                    {/* BENEFITS GRID */}
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-8">Business Scope</h2>
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { title: "Retail Sale", desc: "Sell medicines to end consumers (Chemist Shop/Pharmacy).", icon: Briefcase },
                                { title: "Wholesale", desc: "Supply medicines to retailers or hospitals as a distributor.", icon: Truck },
                                { title: "Stockist", desc: "Become C&F Agents for pharmaceutical companies.", icon: Database },
                                { title: "Credibility", desc: "Drug License is the hallmark of trust in healthcare sector.", icon: Award },
                            ].map((item, i) => (
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-[#2B3446] rounded-3xl p-6 shadow-2xl relative overflow-hidden transform md:-translate-y-4 flex flex-col">
                                ...
                                <ul className="space-y-3 mb-8 flex-1">
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Form 20/21 Application</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Pharmacist Doc Assist</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Refrigerator Affidavit</li>
                                </ul>
                            ...
                            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative group flex flex-col">
                                ...
                                <button onClick={() => handlePlanSelect('manufacturing')} className="w-full py-3 rounded-xl border-2 border-[#2B3446] text-navy font-bold hover:bg-navy hover:text-white transition">Select Mfg</button>
                            </div>
                        </div>
                    </section>
