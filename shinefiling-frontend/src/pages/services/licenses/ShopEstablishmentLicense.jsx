                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-navy mb-6 flex items-center gap-3">
                            <Store className="text-bronze" /> What is Shop Act?
                        </h2>
                        <div className="prose prose-lg text-gray-600">
                            <p className="lead text-xl text-gray-800 font-medium">
                                The Shop and Establishment Act (Gumasta License in some states) regulates conditions of work, lists rights of employees in the unorganized sector, and provides a list of obligations for every employer.
                            </p>
                            <p>
                                It is a mandatory state-based registration for every shop, office, hotel, restaurant, theatre, or place of public amusement. It is the primary document asked by banks to open a Current Account.
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { title: "Legal Proof", desc: "It acts as a primary proof of existence for your business entity.", icon: Shield },
                                { title: "Bank Account", desc: "Mandatory document for opening a Current Bank Account.", icon: Building },
                                { title: "Govt Benefits", desc: "Required to avail various state government benefits and schemes.", icon: Store },
                                { title: "Avoid Penalty", desc: "Avoid heavy fines during inspection by Municipal Corporation.", icon: Zap },
                            ].map((item, i) => (
                    ...
                    <section id="pricing-plans">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-[#2B3446] rounded-3xl p-6 shadow-2xl relative overflow-hidden transform md:-translate-y-4 flex flex-col">
                                <div className="absolute top-0 right-0 bg-bronze text-white text-[10px] font-bold px-3 py-1 rounded-bl-xl uppercase tracking-wider">Small Biz</div>
                                ...
                                <ul className="space-y-3 mb-8 flex-1">
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> &lt; 10 Employees</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Intimation Receipt</li>
                                    <li className="flex gap-3 text-sm text-gray-300"><CheckCircle size={16} className="text-bronze shrink-0" /> Bank Account Ready</li>
                                </ul>
                                <button onClick={() => handlePlanSelect('0-9')} className="w-full py-3 rounded-xl bg-gradient-to-r from-bronze to-yellow-700 text-white font-bold shadow-lg hover:shadow-yellow-500/20 transition">Select Standard</button>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all relative group flex flex-col">
                                ...
                                <button onClick={() => handlePlanSelect('10+')} className="w-full py-3 rounded-xl border-2 border-[#2B3446] text-navy font-bold hover:bg-navy hover:text-white transition">Select Premium</button>
                            </div>
                        </div>
                    </section>
