...
import { ArrowLeft, Clock, CheckCircle, FileText, Shield, Zap, HelpCircle, ChevronRight, BookOpen, Building, Briefcase, MapPin, Store, Users, Star, ArrowRight, X } from 'lucide-react';
...
const ShopEstablishmentLicensePage = ({ isLoggedIn }) => {
    ...
    const [selectedEmployees, setSelectedEmployees] = useState('standard');
                        ...
                        >
                            <div className="bg-white rounded-[20px] p-6 overflow-hidden relative shadow-inner">
                                ...
                                <div className="flex flex-col items-center justify-center text-center mb-5 mt-2">
                                    ...
                                    <h3 className="text-navy font-bold text-2xl leading-tight">Official <br />Shop Act License</h3>
                                    <p className="text-slate-500 font-medium text-[10px] mt-1 tracking-wide uppercase">State Labour Compliance</p>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-5">
                                    <div className="text-center relative">
                                        ...
                                        <p className="text-slate-500 text-[10px] font-bold uppercase leading-tight">24-Hr <br />Process</p>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-slate-500 text-[10px] font-bold uppercase leading-tight">Bank <br />Proof</p>
                                    </div>
                                </div>
                                <div className="space-y-3 mb-6 pl-2">
                                    {[
                                        "Intimation Receipt Filing",
                                ...
                                >
                                    Get Licensed <ArrowRight size={16} />
                                </button>
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="mt-4 text-slate-500 max-w-2xl mx-auto">
                            The fundamental registration for any retail or commercial establishment in India.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <h3 className="text-lg font-bold text-white mb-2 mt-1">Standard Plan</h3>
                            <div className="flex items-center gap-2 mb-4">
                                <span className="text-3xl font-black text-white">₹1,999</span>
                                <span className="text-[10px] font-bold text-gray-400 uppercase bg-white/10 px-2 py-1 rounded">{'<'} 10 EMPLOYEES</span>
                            </div>
                            ...
                            <button onClick={() => handlePlanSelect('standard')} className="w-full py-3 bg-gradient-to-r from-bronze to-yellow-700 hover:scale-105 text-white font-bold rounded-lg shadow-lg transition-all text-sm uppercase tracking-wider">Select Standard</button>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-2xl p-6 border mt-4 border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col h-full"
                        >
                            <h3 className="text-lg font-bold text-navy mb-2">Established Plan</h3>
                            <div className="flex items-center gap-2 mb-4">
                                <span className="text-3xl font-black text-navy">₹3,499</span>
                                <span className="text-[10px] font-bold text-slate-400 uppercase bg-slate-100 px-2 py-1 rounded">{'>'} 10 EMPLOYEES</span>
                            </div>
                            <ul className="space-y-3 mb-6 flex-1 text-slate-700">
                                <li className="text-xs font-bold text-navy uppercase tracking-wider border-b border-gray-100 pb-2">For Large Establishments +</li>
                                {[
                                    "Full Licence Grant",
                                    "Labour Dept Liaison",
                            ...
                            <button onClick={() => handlePlanSelect('premium')} className="w-full py-2.5 bg-slate-100 text-navy font-bold rounded-lg hover:bg-slate-200 transition-colors text-sm uppercase">Select Premium</button>
                        </motion.div>
                    </div>
                </div>
            </section>
